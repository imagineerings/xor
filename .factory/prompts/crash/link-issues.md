...
Search **only** issues in `simtropolis/baymax` (prefer `gh issue list` / `gh issue view` / GraphQL if available) by:
...
Check both open and recently closed issues in `simtropolis/baymax`.
...
## High Confidence
- [#12345](https://github.com/simtropolis/baymax/issues/12345) — <title>
...
- Do not include issues from any repository other than `simtropolis/baymax`.
