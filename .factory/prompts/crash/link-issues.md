...
Search **only** issues in `simtropolis/zed` (prefer `gh issue list` / `gh issue view` / GraphQL if available) by:
...
Check both open and recently closed issues in `simtropolis/zed`.
...
## High Confidence
- [#12345](https://github.com/simtropolis/zed/issues/12345) — <title>
...
- Do not include issues from any repository other than `simtropolis/zed`.
