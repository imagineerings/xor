---
title: Sim-Hosted Models - Sim
description: AI models available via Sim Pro including Claude, GPT-5.5, Gemini 3.1 Pro, and Gemini 3.5 Flash. Pricing, context windows, and tool call support.
---

# Sim-Hosted Models

Sim's plans offer hosted versions of major LLMs with higher rate limits than direct API access. Model availability is updated regularly. To use your own API keys instead, see [LLM Providers](../ai/llm-providers.md). For general setup, see [AI Quick Start](../ai/quick-start.md).

> **Note:** Claude Opus models, GPT-5.5 pro, and GPT-5.4 pro are only available on Sim Pro and Sim Business.

| Model             | Provider  | Token Type          | Provider Price per 1M tokens | Sim Price per 1M tokens |
| ----------------- | --------- | ------------------- | ---------------------------- | ----------------------- |
...
As of February 19, 2026, Sim Pro serves newer model versions in place of the retired models below:
...
| Model             | Provider  | Sim-Hosted Context Window |
| ----------------- | --------- | ------------------------- |
...
> Sim currently limits hosted Gemini 3.1 Pro requests to 200k tokens because pricing changes above that context size.

Each Agent thread in Sim maintains its own context window.
