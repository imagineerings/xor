...
For example, [assets/themes/one/one.json](https://github.com/simtropolis/zed/blob/main/assets/themes/one/one.json) for the default One Dark and One Light themes.
