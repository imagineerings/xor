...
If you always run the same CLI in Terminal Threads, set the `agent.terminal_init_command` setting to have Sim run a command automatically whenever Sim creates a Terminal Thread shell:
