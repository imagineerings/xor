---
title: AI Quick Start - Baymax
description: Choose the right Baymax AI setup path for agents, models, subscriptions, local models, edit prediction, and privacy.
---

# AI Quick Start

Use this page to choose the right AI setup path in Baymax. If you already know the company, subscription, model provider, agent, or CLI you want to use, start with [AI by Company](./by-company.md).

## Use the Baymax Agent {#baymax-agent}

Use [Baymax Agent](./baymax-agent.md) when you want Baymax's native agent to read, edit, search, and run code in your project.

Baymax Agent uses Baymax-configured models from [LLM Providers](./llm-providers.md). It also uses Baymax's built-in tools, [Agent Profiles](./agent-profiles.md), [Skills](./skills.md), [Instructions](./instructions.md), and [MCP servers](./mcp.md).

Start in the [Agent Panel](./agent-panel.md) to prompt the agent, add context, review changes, and manage threads.

### Configure the Baymax Agent {#configure-baymax-agent}
...
## Use Another Coding Agent in Baymax {#agent-cli}

Use this path for Claude, Codex, OpenCode, Copilot, Cursor, Pi Coding Agent, Gemini CLI, or another coding agent.

| If the agent...                 | Use                                       |
| ------------------------------- | ----------------------------------------- |
| Integrates with Baymax through ACP | [External Agents](./external-agents.md)   |
...
## Choose Which Models the Baymax Agent Uses {#model-access}

The Baymax Agent and other model-backed Baymax AI features use models configured through [LLM Providers](./llm-providers.md).

| If you want to...                                                             | Use                                                               |
| ----------------------------------------------------------------------------- | ----------------------------------------------------------------- |
| Use models billed through Baymax                                                 | [Baymax-Hosted Models](../account/baymax-hosted-models.md)              |
...
Provider keys saved through Baymax are stored in the system keychain, not in `settings.json`.
...
| Disable AI, configure tool permissions, or set up edit prediction providers | Settings Editor with {#action baymax::OpenSettings}                         |
| Edit advanced JSON-only settings                                            | Settings file with {#action baymax::OpenSettingsFile}                       |
...
| Understand plans, usage, and billing | [Plans & Pricing](../account/plans-and-pricing.md), [Baymax-Hosted Models](../account/baymax-hosted-models.md), and [Billing](../account/billing.md) |

## Turn AI Off {#turn-ai-off}

Open the Settings Editor with {#action baymax::OpenSettings}, search for `Disable AI`, and enable it.
