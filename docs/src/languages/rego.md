---
title: Rego
description: "Configure Rego language support in Baymax, including language servers, formatting, and debugging."
---

# Rego

Rego language support in Baymax is provided by the community-maintained [Rego extension](https://github.com/StyraInc/baymax-rego).
