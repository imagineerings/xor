---
title: Rego
description: "Configure Rego language support in Sim, including language servers, formatting, and debugging."
---

# Rego

Rego language support in Sim is provided by the community-maintained [Rego extension](https://github.com/StyraInc/sim-rego).
