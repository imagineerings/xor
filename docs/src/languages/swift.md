---
title: Swift
description: "Configure Swift language support in Sim, including language servers, formatting, and debugging."
---

# Swift

Swift language support in Sim is provided by the community-maintained [Swift extension](https://github.com/sim-extensions/swift).
Report issues to: [https://github.com/sim-extensions/swift/issues](https://github.com/sim-extensions/swift/issues)
...
Sim's name for the adapter (in the UI and `debug.json`) is `Swift`, and under the hood it uses [`lldb-dap`](https://github.com/swiftlang/llvm-project/blob/next/lldb/tools/lldb-dap/README.md), as provided by the Swift toolchain.
...
[
  {
    ...
    "program": "$SIM_WORKTREE_ROOT/swift-app/.build/arm64-apple-macosx/debug/swift-app",
    "request": "launch",
    "adapter": "Swift"
  }
]
