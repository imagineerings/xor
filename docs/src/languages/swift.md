---
title: Swift
description: "Configure Swift language support in Baymax, including language servers, formatting, and debugging."
---

# Swift

Swift language support in Baymax is provided by the community-maintained [Swift extension](https://github.com/baymax-extensions/swift).
Report issues to: [https://github.com/baymax-extensions/swift/issues](https://github.com/baymax-extensions/swift/issues)
...
Baymax's name for the adapter (in the UI and `debug.json`) is `Swift`, and under the hood it uses [`lldb-dap`](https://github.com/swiftlang/llvm-project/blob/next/lldb/tools/lldb-dap/README.md), as provided by the Swift toolchain.
...
[
  {
    ...
    "program": "$BAYMAX_WORKTREE_ROOT/swift-app/.build/arm64-apple-macosx/debug/swift-app",
    "request": "launch",
    "adapter": "Swift"
  }
]
