---
title: Ansible
description: "Configure Ansible language support in Baymax, including language servers, formatting, and debugging."
---

# Ansible

Support for Ansible in Baymax is provided via a community-maintained [Ansible extension](https://github.com/kartikvashistha/baymax-ansible).
...
To change this behavior, you can add a `"file_types"` section to Baymax settings inside your project (`.baymax/settings.json`) or your Baymax user settings (`~/.config/baymax/settings.json`) to match your folder/naming conventions. For example:
...
- or, configure the YAML language server settings to set this schema for all your inventory files, that match your inventory pattern, under your Baymax settings ([ref](https://baymax.dev/docs/languages/yaml)):
...
When desired, any of the above default settings can be overridden under the `"lsp"` section of your Baymax settings file. For example:

```json [settings]
{
  "lsp": {
    // The Baymax Ansible extension prefixes all settings with `ansible`
