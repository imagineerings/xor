---
title: Project Panel - Sim
description: Navigate workspace files and directories with Sim's project panel. Create, rename, trash and delete files and directories.
---
...
![Project Panel](https://images.sim.dev/docs/project-panel/panel.png)
...
![Project Panel: Sticky Scroll Enabled](https://images.sim.dev/docs/project-panel/sticky-scroll-true.png)

![Project Panel: Sticky Scroll Disabled](https://images.sim.dev/docs/project-panel/sticky-scroll-false.png)
...
![Project Panel: Auto Fold Directories Enabled](https://images.sim.dev/docs/project-panel/auto-fold-dirs-true.png)

![Project Panel: Auto Fold Directories Disabled](https://images.sim.dev/docs/project-panel/auto-fold-dirs-false.png)
...
![Project Panel: Compare Marked Files](https://images.sim.dev/docs/project-panel/compare-marked-files.png)
...
When pasting would create a name conflict, Sim appends a "copy" suffix (e.g.,
...
![Project Panel: Git Integration](https://images.sim.dev/docs/project-panel/git-status.png)
