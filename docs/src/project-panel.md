---
title: Project Panel - Baymax
description: Navigate workspace files and directories with Baymax's project panel. Create, rename, trash and delete files and directories.
---
...
![Project Panel](https://images.baymax.dev/docs/project-panel/panel.png)
...
![Project Panel: Sticky Scroll Enabled](https://images.baymax.dev/docs/project-panel/sticky-scroll-true.png)

![Project Panel: Sticky Scroll Disabled](https://images.baymax.dev/docs/project-panel/sticky-scroll-false.png)
...
![Project Panel: Auto Fold Directories Enabled](https://images.baymax.dev/docs/project-panel/auto-fold-dirs-true.png)

![Project Panel: Auto Fold Directories Disabled](https://images.baymax.dev/docs/project-panel/auto-fold-dirs-false.png)
...
![Project Panel: Compare Marked Files](https://images.baymax.dev/docs/project-panel/compare-marked-files.png)
...
When pasting would create a name conflict, Baymax appends a "copy" suffix (e.g.,
...
![Project Panel: Git Integration](https://images.baymax.dev/docs/project-panel/git-status.png)
