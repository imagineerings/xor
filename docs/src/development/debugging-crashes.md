...
If telemetry is enabled, Zed uploads these reports when you restart the app. Reports are sent to a [Slack channel](https://simtropolis.slack.com/archives/C0977J9MA1Y) and to [Sentry](https://zed-dev.sentry.io/issues) (both are Zed-staff-only).
