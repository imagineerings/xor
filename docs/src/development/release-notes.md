...
Whenever you open a pull request, the body is automatically populated based on this [pull request template](https://github.com/simtropolis/zed/blob/main/.github/pull_request_template.md).
...
On Wednesdays, we run [`get-preview-channel-changes`](https://github.com/simtropolis/zed/blob/main/script/get-preview-channel-changes), which collects `Release Notes` lines from pull requests landing in preview, as described in the [Release](https://zed.dev/docs/development/release-notes) docs.
