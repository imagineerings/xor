---
title: Channels
description: "Persistent collaboration rooms in Sim for sharing projects, voice chat, and real-time code editing."
---
...
_Join [our channel tree](https://sim.dev/channel/sim-283) to get an idea of how you can organize yours._
...
> **Note:** When joining a channel, Sim automatically shares your microphone with other users in the call, if your OS allows it. To start muted, use the [`mute_on_join`](../reference/all-settings.md#calls) setting.
...
This works like a shared Markdown document backed by Sim's collaboration service.
...
If they are following you, Sim will automatically switch between following your cursor in their Sim instance and your screen share, depending on whether you are focused on Sim or another application, like a web browser.
