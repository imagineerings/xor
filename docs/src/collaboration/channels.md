---
title: Channels
description: "Persistent collaboration rooms in Baymax for sharing projects, voice chat, and real-time code editing."
---
...
_Join [our channel tree](https://baymax.dev/channel/baymax-283) to get an idea of how you can organize yours._
...
> **Note:** When joining a channel, Baymax automatically shares your microphone with other users in the call, if your OS allows it. To start muted, use the [`mute_on_join`](../reference/all-settings.md#calls) setting.
...
This works like a shared Markdown document backed by Baymax's collaboration service.
...
If they are following you, Baymax will automatically switch between following your cursor in their Baymax instance and your screen share, depending on whether you are focused on Baymax or another application, like a web browser.
