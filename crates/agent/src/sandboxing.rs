...
//!
//! macOS and Windows have terminal sandbox integrations. Other hosts return
//! `false` regardless of the feature flag.
//!
...
pub(crate) fn sandboxing_enabled_for_local_project(is_local: bool, cx: &App) -> bool {
    is_local && sandboxing_enabled(cx)
}
...
pub(crate) struct SandboxRequest {
    ...
    /// Allow access to the project's protected Git metadata on macOS.
