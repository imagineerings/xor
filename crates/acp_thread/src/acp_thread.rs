...
mod tests {
    ...
    async fn test_duplicate_tool_call_update_preserves_open_permission_request_until_authorized(
        ...
        let permission_task = thread
            ...
            .expect("permission request should be created");
        ...
        thread
            ...
            .expect("tool call should update");
        ...
        thread
            ...
            .expect("tool call should update again");
        ...
        thread
            ...
            .expect("completed update should be applied");
