...
/// Registry for managing and launching sim apps.
pub struct AppRegistry {
    apps: HashMap<String, Box<dyn SimApp>>,
...
impl AppRegistry {
    ...
    pub fn active_app(&self) -> Option<&dyn SimApp> {
        self.active_app
            .as_ref()
    ...
    pub fn active_app_mut(&mut self) -> Option<&mut dyn SimApp> {
...
mod tests {
    ...
    fn test_app(id: &'static str, name: &'static str) -> Box<dyn SimApp> {
