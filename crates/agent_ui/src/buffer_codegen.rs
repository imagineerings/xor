...
impl CodegenAlternative {
    ...
    pub fn handle_stream(
        ...
        // as in https://github.com/simtropolis/baymax/issues/39088
...
mod tests {
    ...
    async fn test_allows_model_to_output_backticks(cx: &mut TestAppContext) {
        init_test(cx);
        let text = "- Improved; `cmd+click` behavior. Now requires `cmd` to be pressed before the click starts or it doesn't run. ([#44579](https://github.com/simtropolis/baymax/pull/44579); thanks [Zachiah](https://github.com/Zachiah))";
