...
//! It uses Baymax's terminal emulator to process and display text, supporting ANSI escape
...
/// * error tracebacks
///
/// It uses Baymax's terminal emulator backend to process and render text,
