...
pub struct SimGameSourcePath(PathBuf);

impl SimGameSourcePath {
...
impl MigrationSourceArea {
    pub fn new(
        ...
        Self {
            name: name.into(),
            source: SimGameSourcePath::new(source),
            scope: scope.into(),
            decision,
...
impl SimGameMigrationInventory for MigrationInventory {
    fn validate_spec_pack(&self) -> MigrationValidationReport {
