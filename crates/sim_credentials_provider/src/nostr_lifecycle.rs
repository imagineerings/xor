...
const CREDENTIAL_PROBE_IDENTIFIER: &str = "sim-nostr://credential/probe/v1";
const GENERATION_CHALLENGE_DOMAIN: &[u8] = b"sim.collaboration.nostr-generation.v1\0";
const RESOLUTION_CHALLENGE_DOMAIN: &[u8] = b"sim.collaboration.nostr-resolution.v1\0";
