...
static AMBIGUOUS_FAMILY: ModelFamilyDefinition = ModelFamilyDefinition {
    feature_id: "COMFY-MODEL-9089",
    identifier: "HunyuanImage21AmbiguousFixture",
    ..row_image::MODEL_FAMILY
};
...
static AMBIGUOUS_REGISTRATIONS: [ModelFamilyRegistration; 2] = [
    ...
    ModelFamilyRegistration {
        ...
        source_ordinal: 137,
        source_architecture: "model_base.HunyuanImage21AmbiguousFixture",
        ..row_image::MODEL_FAMILY_REGISTRATION
    },
];

pub(super) const SPEC: RowSpec = RowSpec {
    feature_id: row_image::MODEL_FAMILY_FEATURE_ID,
    identifier: row_image::MODEL_FAMILY_IDENTIFIER,
    fixture: row_image::MODEL_FAMILY_FIXTURE,
    module: "hunyuanimage21_comfy_model_0089",
    source_ordinal: row_image::MODEL_FAMILY_SOURCE_ORDINAL,
    ...
    latent_symbol: "latent_formats.HunyuanImage21",
    clip_tokenizer: "comfy.text_encoders.hunyuan_image.HunyuanImageTokenizer",
    clip_model: "comfy.text_encoders.hunyuan_image.te",
    projection_sha256: row_image::MODEL_FAMILY_PROJECTION_SHA256,
    registration: row_image::MODEL_FAMILY_REGISTRATION,
    artifact_digest: "0089008900890089008900890089008900890089008900890089008900890089",
    variant: HunyuanVideoVariant::Image21,
...
#[test]
fn val_model_family_row_001_hunyuanimage21_source_detection_provenance_and_ownership()
-> Result<(), Box<dyn std::error::Error>> {
    assert_source_contract(SPEC)
}

#[test]
fn val_model_family_row_001_hunyuanimage21_mapping_forward_patch_and_memory()
-> Result<(), Box<dyn std::error::Error>> {
    assert_execution_contract(SPEC)
}

#[test]
fn val_model_family_row_001_hunyuanimage21_dtype_device_and_typed_failures()
-> Result<(), Box<dyn std::error::Error>> {
...
fn all_specs() -> [RowSpec; 4] {
    [
        super::generated_hunyuanvideo15_comfy_model_0092::SPEC,
        super::generated_hunyuanimage21refiner_comfy_model_0090::SPEC,
        SPEC,
        super::generated_hunyuanvideo_comfy_model_0091::SPEC,
    ]
}
...
fn detector_shapes(spec: RowSpec) -> Vec<(String, Vec<u64>)> {
    ...
    if matches!(spec.variant, HunyuanVideoVariant::Video | HunyuanVideoVariant::Video15) {
        shapes.extend([
    ...
    if spec.variant == HunyuanVideoVariant::Video15 {
        shapes.extend([
