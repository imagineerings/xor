...
pub const MODEL_FAMILY_IDENTIFIER: &str = "HunyuanVideoI2V";
pub const MODEL_FAMILY_FEATURE_ID: &str = "COMFY-MODEL-0094";
pub const MODEL_FAMILY_FIXTURE: &str = "hunyuanvideoi2v-comfy-model-0094";
pub const MODEL_FAMILY_SOURCE_ORDINAL: u16 = 39;
...
pub const MODEL_FAMILY_PROJECTION_SHA256: &str =
    "baec5b467515040be3f68efb7901a0a6236e02b74fef28036f8dc6cbe248ec49";
...
fn select_profile(probe: &ModelProbe) -> Result<ModelFamilyProfile, ModelFamilyError> {
    ...
    if configuration.variant != HunyuanVideoVariant::VideoI2V {
        return Err(ModelFamilyError::InvalidSelectorOutput(format!(
            "HunyuanVideoI2V row cannot admit {:?}",
        ...
        || configuration.latent_format.identifier != HUNYUAN_VIDEO_LATENT_FORMAT.identifier
    {
        return Err(ModelFamilyError::InvalidSelectorOutput(
            "HunyuanVideoI2V latent selection drifted".to_owned(),
        ));
    }
