use crate::{
    ...
    COGVIDEOX_PATCH_PROJECTION_KEYS, CogVideoXConfiguration, CogVideoXLatentVariant,
    CogVideoXLayout, MODEL_STATE_TRANSFORM_PLAN_SCHEMA_VERSION, MemoryEstimatorDescriptor,
