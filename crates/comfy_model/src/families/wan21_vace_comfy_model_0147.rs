use crate::{
    ...
    generated_wan21_t2v_comfy_model_0146::{
        FFN_WEIGHT, HEAD_MODULATION, HEAD_WEIGHT, PATCH_WEIGHT, VACE_PATCH_WEIGHT,
        WAN21_OPTIONAL_KEYS, WAN21_REQUIRED_KEYS, WAN21_WEIGHT_RULES, Wan21BatchConfiguration,
        Wan21BatchVariant, batch_configuration_for_probe,
    },
};

pub const MODEL_FAMILY_IDENTIFIER: &str = "WAN21_Vace";
pub const MODEL_FAMILY_FEATURE_ID: &str = "COMFY-MODEL-0147";
pub const MODEL_FAMILY_FIXTURE: &str = "wan21-vace-comfy-model-0147";
pub const MODEL_FAMILY_SOURCE_ORDINAL: u16 = 55;
...
pub const MODEL_FAMILY_PROJECTION_SHA256: &str =
    "5d942f5126d7780be836d31fbb454d5eb3701655c61a4a6c60259756c704f887";
pub const MODEL_FAMILY_SHIFT: f64 = 8.0;
pub const SOURCE_ARCHITECTURE: &str = "model_base.WAN21_Vace";

const COMPONENTS: &[ModelFamilyComponent] = &[
    ModelFamilyComponent {
        identifier: "model",
        role: "Wan 2.1 Vace context-conditioned video transformer",
        required: true,
    },
    ModelFamilyComponent {
        identifier: "runtime_conditioning",
        role: "Vace context/strength contract and source sampling shift",
        required: true,
    },
    ModelFamilyComponent {
...
const DETECTION_RULES: &[ModelDetectionRule] = &[
    ...
    ModelDetectionRule::KeyPresent {
        key: VACE_PATCH_WEIGHT,
        score: 700,
    },
];
const FORWARD_PROGRAM: &[ModelForwardStep] = &[
    ModelForwardStep {
        checkpoint: "vace_timestep_embedding",
    ...
    ModelForwardStep {
        checkpoint: "vace_context_conditioning",
        operation: ModelForwardOperation::Silu,
    },
    ModelForwardStep {
        checkpoint: "vace_transformer_block",
        operation: ModelForwardOperation::Linear {
    ...
    ModelForwardStep {
        checkpoint: "vace_block_normalization",
    ...
    ModelForwardStep {
        checkpoint: "vace_head_projection",
        operation: ModelForwardOperation::Linear {
...
pub const MODEL_FAMILY: ModelFamilyDefinition = ModelFamilyDefinition {
    ...
    architecture_version: "wan21-vace-v1",
...
const NATIVE_STATE_PLAN: ModelStateTransformPlanDefinition = ModelStateTransformPlanDefinition {
    ...
    encoded_plan: r#"{
        "operations": [
            ...
            {"Generate":{"shape":[{"Literal":1}],"fill":{"float":1.0},"dtype":"f32","output":{"component":"runtime_conditioning","key":"vace_context"}}},
            {"Generate":{"shape":[{"Literal":1}],"fill":{"float":1.0},"dtype":"f32","output":{"component":"runtime_conditioning","key":"vace_strength"}}}
        ],
        "unmatched":"Reject"
    }"#,
};
...
const LAYOUT_SIGNATURES: &[ModelLayoutSignature] = &[ModelLayoutSignature {
    ...
    required_prefixes: &["model.diffusion_model.vace_blocks."],
}];
const COMPONENT_STATE_SCHEMAS: &[ModelFamilyComponentStateSchema] = &[
    ...
    ModelFamilyComponentStateSchema {
        ...
        required_keys: &["sampling_shift", "vace_context", "vace_strength"],
        optional_keys: &[],
...
pub const MODEL_FAMILY_REGISTRATION: ModelFamilyRegistration = ModelFamilyRegistration {
    ...
    required_state_keys: &[VACE_PATCH_WEIGHT],
...
pub fn configuration_for_probe(
    ...
    if probe.select_layout(LAYOUT_SIGNATURES)? != ModelStateLayout::PrefixedNative {
        return Err(ModelFamilyError::InvalidSelectorOutput(
            "WAN21_Vace requires the source-native prefixed layout".to_owned(),
        ));
    }
    batch_configuration_for_probe(probe, Wan21BatchVariant::Vace)
}
