...
pub const MODEL_FAMILY_IDENTIFIER: &str = "HunyuanVideo";
pub const MODEL_FAMILY_FEATURE_ID: &str = "COMFY-MODEL-0091";
pub const MODEL_FAMILY_FIXTURE: &str = "hunyuanvideo-comfy-model-0091";
pub const MODEL_FAMILY_SOURCE_ORDINAL: u16 = 40;
...
pub const MODEL_FAMILY_PROJECTION_SHA256: &str =
    "ccf3513980707997ef308b06b90581b552cb47e19f96fdceb0b17bd2c4e1a2bd";
...
fn select_profile(probe: &ModelProbe) -> Result<ModelFamilyProfile, ModelFamilyError> {
    ...
    if configuration.variant != HunyuanVideoVariant::Video {
        return Err(ModelFamilyError::InvalidSelectorOutput(format!(
            "HunyuanVideo row cannot admit {:?}",
        ...
        || configuration.latent_format.identifier != HUNYUAN_VIDEO_LATENT_FORMAT.identifier
    {
        return Err(ModelFamilyError::InvalidSelectorOutput(
            "HunyuanVideo latent selection drifted".to_owned(),
        ));
    }
