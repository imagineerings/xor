...
pub const MODEL_FAMILY_IDENTIFIER: &str = "WAN21_FunControl2V";
pub const MODEL_FAMILY_FEATURE_ID: &str = "COMFY-MODEL-0141";
pub const MODEL_FAMILY_FIXTURE: &str = "wan21-funcontrol2v-comfy-model-0141";
pub const MODEL_FAMILY_SOURCE_ORDINAL: u16 = 54;
...
pub const MODEL_FAMILY_PROJECTION_SHA256: &str =
    "6f855f5b7fd8ba44768349f63e19b69e3b043db0bb061b06b693b5b7f55e5aaf";
...
const COMPONENTS: &[ModelFamilyComponent] = &[
    ModelFamilyComponent {
        identifier: "model",
        role: "Wan 2.1 FunControl image-conditioned video transformer",
        required: true,
    },
    ModelFamilyComponent {
        identifier: "runtime_conditioning",
        role: "FunControl concatenation contract and sampling shift",
        required: true,
    },
    ModelFamilyComponent {
...
const FORWARD_PROGRAM: &[ModelForwardStep] = &[
    ModelForwardStep {
        checkpoint: "funcontrol_timestep_embedding",
    ...
    ModelForwardStep {
        checkpoint: "funcontrol_concat_conditioning",
        operation: ModelForwardOperation::Silu,
    },
    ModelForwardStep {
        checkpoint: "funcontrol_transformer_block",
        operation: ModelForwardOperation::Linear {
    ...
    ModelForwardStep {
        checkpoint: "funcontrol_block_normalization",
    ...
    ModelForwardStep {
        checkpoint: "funcontrol_head_projection",
        operation: ModelForwardOperation::Linear {
    ...
    ModelForwardStep {
        checkpoint: "funcontrol_video_output",
...
pub const MODEL_FAMILY: ModelFamilyDefinition = ModelFamilyDefinition {
    ...
    architecture_version: "wan21-funcontrol2v-v1",
...
const NATIVE_STATE_PLAN: ModelStateTransformPlanDefinition = ModelStateTransformPlanDefinition {
    ...
    encoded_plan: r#"{
        "operations": [
            ...
            {"Generate":{"shape":[{"Literal":1}],"fill":{"float":32.0},"dtype":"f32","output":{"component":"runtime_conditioning","key":"concat_condition_channels"}}}
        ],
        "unmatched":"Reject"
    }"#,
};
...
const COMPONENT_STATE_SCHEMAS: &[ModelFamilyComponentStateSchema] = &[
    ...
    ModelFamilyComponentStateSchema {
        ...
        required_keys: &["sampling_shift", "image_to_video", "concat_condition_channels"],
        optional_keys: &[],
...
pub fn configuration_for_probe(
    ...
    if probe.select_layout(LAYOUT_SIGNATURES)? != ModelStateLayout::PrefixedNative {
        return Err(ModelFamilyError::InvalidSelectorOutput(
            "WAN21_FunControl2V requires the source-native prefixed layout".to_owned(),
        ));
    }
    extended_configuration_for_probe(probe, Wan21ExtendedVariant::FunControl2V)
}
