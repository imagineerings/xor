use crate::{
    HUNYUANDIT_CLIP_TARGET, HUNYUANDIT_COMPONENTS, HUNYUANDIT_DIT1_EXTRA_INPUT,
...
pub const MODEL_FAMILY_IDENTIFIER: &str = "HunyuanDiT1";
pub const MODEL_FAMILY_FEATURE_ID: &str = "COMFY-MODEL-0088";
pub const MODEL_FAMILY_FIXTURE: &str = "hunyuandit1-comfy-model-0088";
pub const MODEL_FAMILY_SOURCE_ORDINAL: u16 = 26;
...
pub const MODEL_FAMILY_PROJECTION_SHA256: &str =
    "eba3580cd0bd6efd14a2b214cdf691a7c993f816375b097cfed83700c5dd2e48";
...
pub const MODEL_FAMILY_SAMPLING_LINEAR_END: f64 = 0.03;
...
const DIT1_EXTRA_FACTS: &[ModelTensorFactPredicate] = &[
    ModelTensorFactPredicate {
        subject: ModelTensorFactSubject::Rank,
        relation: ModelTensorFactRelation::Equal,
        value: 2,
...
fn select_profile(probe: &ModelProbe) -> Result<ModelFamilyProfile, ModelFamilyError> {
    ...
    if configuration.variant != HunyuanDiTVariant::DiT1 {
        return Err(ModelFamilyError::InvalidSelectorOutput(format!(
            "HunyuanDiT1 row cannot admit {:?}",
