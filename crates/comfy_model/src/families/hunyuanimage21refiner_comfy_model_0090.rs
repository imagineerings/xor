use crate::{
    HUNYUAN_IMAGE21_REFINER_LATENT_FORMAT, HUNYUAN_VIDEO_CLIP_TARGET,
...
pub const MODEL_FAMILY_IDENTIFIER: &str = "HunyuanImage21Refiner";
pub const MODEL_FAMILY_FEATURE_ID: &str = "COMFY-MODEL-0090";
pub const MODEL_FAMILY_FIXTURE: &str = "hunyuanimage21refiner-comfy-model-0090";
pub const MODEL_FAMILY_SOURCE_ORDINAL: u16 = 36;
...
pub const MODEL_FAMILY_PROJECTION_SHA256: &str =
    "9abe641df967ee6bcffad5adf49a7ec59af7180429f296ec39491620248c6370";
...
fn select_profile(probe: &ModelProbe) -> Result<ModelFamilyProfile, ModelFamilyError> {
    ...
    if configuration.variant != HunyuanVideoVariant::Image21Refiner {
        return Err(ModelFamilyError::InvalidSelectorOutput(format!(
            "HunyuanImage21Refiner row cannot admit {:?}",
            configuration.variant
        )));
    }
    if configuration.latent_format.feature_id
        != HUNYUAN_IMAGE21_REFINER_LATENT_FORMAT.feature_id
        || configuration.latent_format.identifier
            != HUNYUAN_IMAGE21_REFINER_LATENT_FORMAT.identifier
    {
        return Err(ModelFamilyError::InvalidSelectorOutput(
            "HunyuanImage21Refiner latent selection drifted".to_owned(),
        ));
    }
