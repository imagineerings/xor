...
pub const MODEL_FAMILY_IDENTIFIER: &str = "SDXL_instructpix2pix";
pub const MODEL_FAMILY_FEATURE_ID: &str = "COMFY-MODEL-0125";
pub const MODEL_FAMILY_FIXTURE: &str = "sdxl-instructpix2pix-comfy-model-0125";
pub const MODEL_FAMILY_SOURCE_ORDINAL: u16 = 7;
...
pub const MODEL_FAMILY_PROJECTION_SHA256: &str =
    "2520b71f50abb9f1bb991fb37d2c8c34546dc6393da2731606663c53124ece32";
pub const MODEL_FAMILY_MEMORY_USAGE_FACTOR: f64 = sdxl_family::SDXL_MEMORY_USAGE_FACTOR;
pub const SOURCE_ARCHITECTURE: &str = "model_base.SDXL_instructpix2pix";
...
const DEEPEST_CONTEXT_KEYS: &[&str] = &[
    ...
    "input_blocks.7.1.transformer_blocks.9.attn2.to_k.weight",
...
pub const MODEL_FAMILY: ModelFamilyDefinition = ModelFamilyDefinition {
    ...
    architecture_version: "sdxl-instruct-pix2pix-v1",
...
pub fn configuration_for_probe(
    ...
    if configuration.variant != SdxlVariant::InstructPix2Pix {
        return Err(ModelFamilyError::InvalidSelectorOutput(format!(
            "SDXL_instructpix2pix requires the source-exact 8-channel/depth-10 profile, found {:?}",
