...
pub const MODEL_FAMILY_IDENTIFIER: &str = "CogVideoX_I2V";
pub const MODEL_FAMILY_FEATURE_ID: &str = "COMFY-MODEL-0068";
pub const MODEL_FAMILY_FIXTURE: &str = "cogvideox-i2v-comfy-model-0068";
pub const MODEL_FAMILY_SOURCE_ORDINAL: u16 = 90;
...
pub const MODEL_FAMILY_PROJECTION_SHA256: &str =
    "8b530e263788a609c5613cd03fb164f19a76c82b67e4754fbf6477f7f60d7bc1";
pub const MODEL_FAMILY_MEMORY_USAGE_FACTOR: f64 = 2.0;

pub type CogVideoXI2VConfiguration = CogVideoXConfiguration;
...
const COMPONENTS: &[ModelFamilyComponent] = &[
    ModelFamilyComponent {
        identifier: "model",
        role: "image-to-video diffusion transformer",
        required: true,
    },
    ModelFamilyComponent {
        identifier: "vae",
...
pub const MODEL_FAMILY: ModelFamilyDefinition = ModelFamilyDefinition {
    ...
    architecture_version: "cogvideox-i2v-transformer-3d-v1",
...
pub fn configuration_for_probe(
    probe: &ModelProbe,
) -> Result<CogVideoXI2VConfiguration, ModelFamilyError> {
    cogvideox_configuration_for_probe(probe, 32, MODEL_FAMILY_IDENTIFIER)
}
