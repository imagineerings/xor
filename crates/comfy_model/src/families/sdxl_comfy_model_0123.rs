...
pub const MODEL_FAMILY_IDENTIFIER: &str = "SDXL";
pub const MODEL_FAMILY_FEATURE_ID: &str = "COMFY-MODEL-0123";
pub const MODEL_FAMILY_FIXTURE: &str = "sdxl-comfy-model-0123";
pub const MODEL_FAMILY_SOURCE_ORDINAL: u16 = 9;
...
pub const MODEL_FAMILY_PROJECTION_SHA256: &str =
    "a70a1442584f776383fd10f3eb134e0b5e9b66e953e4d390368083ddea79074d";
...
pub const MODEL_FAMILY: ModelFamilyDefinition = ModelFamilyDefinition {
    ...
    architecture_version: "sdxl-base-v1",
...
pub fn configuration_for_probe(probe: &ModelProbe) -> Result<SdxlConfiguration, ModelFamilyError> {
    ...
    if configuration.variant != SdxlVariant::Base {
        return Err(ModelFamilyError::InvalidSelectorOutput(format!(
            "SDXL requires the source-exact 4-channel/depth-10 base profile, found {:?}",
