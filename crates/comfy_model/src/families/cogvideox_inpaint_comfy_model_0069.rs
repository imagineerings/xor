...
pub const MODEL_FAMILY_IDENTIFIER: &str = "CogVideoX_Inpaint";
pub const MODEL_FAMILY_FEATURE_ID: &str = "COMFY-MODEL-0069";
pub const MODEL_FAMILY_FIXTURE: &str = "cogvideox-inpaint-comfy-model-0069";
pub const MODEL_FAMILY_SOURCE_ORDINAL: u16 = 89;
...
pub const MODEL_FAMILY_PROJECTION_SHA256: &str =
    "40009f07ead0b4e05a7df803cc9c695e589b214331ae1e440d9061a214a69f64";
pub const MODEL_FAMILY_MEMORY_USAGE_FACTOR: f64 = 2.0;

pub type CogVideoXInpaintConfiguration = CogVideoXConfiguration;
...
const COMPONENTS: &[ModelFamilyComponent] = &[
    ModelFamilyComponent {
        identifier: "model",
        role: "video inpainting diffusion transformer",
        required: true,
    },
    ModelFamilyComponent {
        identifier: "vae",
...
pub const MODEL_FAMILY: ModelFamilyDefinition = ModelFamilyDefinition {
    ...
    architecture_version: "cogvideox-inpaint-transformer-3d-v1",
...
fn select_profile(probe: &ModelProbe) -> Result<ModelFamilyProfile, ModelFamilyError> {
    ...
    let (latent_feature_id, latent_identifier) = match configuration.latent_variant {
        CogVideoXLatentVariant::CogVideoX => ("COMFY-MODEL-0026", "CogVideoX"),
        CogVideoXLatentVariant::CogVideoX1_5 => ("COMFY-MODEL-0027", "CogVideoX1_5"),
    };
...
pub fn configuration_for_probe(
    probe: &ModelProbe,
) -> Result<CogVideoXInpaintConfiguration, ModelFamilyError> {
    cogvideox_configuration_for_probe(probe, 48, MODEL_FAMILY_IDENTIFIER)
}
