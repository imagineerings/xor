use crate::{
    HUNYUAN_VIDEO_CLIP_TARGET, HUNYUAN_VIDEO_COMPONENT_STATE_SCHEMAS,
    HUNYUAN_VIDEO_COMPONENTS, HUNYUAN_VIDEO_FORWARD_PROGRAM, HUNYUAN_VIDEO_LATENT_FORMAT,
    HUNYUAN_VIDEO_PREFIXED_STATE_PLAN, HUNYUAN_VIDEO_SAVED_MODEL_STATE_PLAN,
    HUNYUAN_VIDEO_STANDALONE_STATE_PLAN, HUNYUAN_VIDEO_SUPPORTED_DEVICES,
    HUNYUAN_VIDEO_SUPPORTED_DTYPES, HunyuanVideoVariant, MemoryEstimatorDescriptor,
    ...
    ModelTensorFactPredicate, ModelTensorFactRelation, ModelTensorFactSubject, ModelWeightRule,
    hunyuan_video_configuration_for_probe,
};

pub const MODEL_FAMILY_IDENTIFIER: &str = "HunyuanVideoSkyreelsI2V";
pub const MODEL_FAMILY_FEATURE_ID: &str = "COMFY-MODEL-0095";
pub const MODEL_FAMILY_FIXTURE: &str = "hunyuanvideoskyreelsi2v-comfy-model-0095";
pub const MODEL_FAMILY_SOURCE_ORDINAL: u16 = 38;
...
pub const MODEL_FAMILY_PROJECTION_SHA256: &str =
    "0f0756cf188ff7824706f669dcaaf344f994a1df49fce8f8a6fe20c0cbda9abc";
pub const MODEL_FAMILY_MEMORY_USAGE_FACTOR: f64 = 1.8;
pub const MODEL_FAMILY_SAMPLING_SHIFT: f64 = 7.0;
...
pub const MODEL_FAMILY: ModelFamilyDefinition = ModelFamilyDefinition {
    ...
    architecture_version: "hunyuan-video-skyreels-i2v-flow-transformer-v1",
    latent_feature_id: "COMFY-MODEL-0037",
    latent_identifier: "HunyuanVideo",
    clip_target: &HUNYUAN_VIDEO_CLIP_TARGET,
...
pub const MODEL_FAMILY_REGISTRATION: ModelFamilyRegistration = ModelFamilyRegistration {
    ...
    source_ordinal: 38,
    source_architecture: "model_base.HunyuanVideoSkyreelsI2V",
    source_configuration: &[],
    required_state_keys: &[],
    profile_selector: Some(select_profile),
    clip_target_selector: ModelClipTargetSelector::Static(&HUNYUAN_VIDEO_CLIP_TARGET),
...
fn select_profile(probe: &ModelProbe) -> Result<ModelFamilyProfile, ModelFamilyError> {
    ...
    if configuration.variant != HunyuanVideoVariant::VideoSkyreelsI2V {
        return Err(ModelFamilyError::InvalidSelectorOutput(format!(
            "HunyuanVideoSkyreelsI2V row cannot admit {:?}",
            configuration.variant
        )));
    }
    if configuration.latent_format.feature_id != HUNYUAN_VIDEO_LATENT_FORMAT.feature_id
        || configuration.latent_format.identifier != HUNYUAN_VIDEO_LATENT_FORMAT.identifier
    {
        return Err(ModelFamilyError::InvalidSelectorOutput(
            "HunyuanVideoSkyreelsI2V latent selection drifted".to_owned(),
        ));
    }
