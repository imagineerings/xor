use crate::{
    COSMOS_CLIP_TARGET, COSMOS_GENERAL_DETECTION_MARKER_KEYS, COSMOS_GENERAL_STATE_PLAN_CASES,
    COSMOS_LAYOUT_SIGNATURES, COSMOS_PATCH_PROJECTION_KEYS, COSMOS_SUPPORTED_DEVICES,
    COSMOS_SUPPORTED_DTYPES, COSMOS_WEIGHT_RULES, CosmosArchitecture, CosmosConfiguration,
    CosmosModelSize, MemoryEstimatorDescriptor, ModelClipTargetSelector, ModelDetectionRule,
    ...
    ModelForwardOperation, ModelForwardStep, ModelProbe, cosmos_configuration_for_probe,
};

pub const MODEL_FAMILY_IDENTIFIER: &str = "CosmosI2V";
pub const MODEL_FAMILY_FEATURE_ID: &str = "COMFY-MODEL-0071";
pub const MODEL_FAMILY_FIXTURE: &str = "cosmosi2v-comfy-model-0071";
pub const MODEL_FAMILY_SOURCE_ORDINAL: u16 = 42;
...
pub const MODEL_FAMILY_PROJECTION_SHA256: &str =
    "9b9a13b4eb2d6faa56af039a8a9760d102cbcbeefd4e1f820be19188171b9af3";
...
pub type CosmosI2VModelSize = CosmosModelSize;
pub type CosmosI2VConfiguration = CosmosConfiguration;

const COMPONENTS: &[ModelFamilyComponent] = &[
    ModelFamilyComponent {
        identifier: "model",
        role: "Cosmos image-to-video diffusion transformer",
        required: true,
    },
    ModelFamilyComponent {
        identifier: "vae",
...
const DETECTION_RULES: &[ModelDetectionRule] = &[
    ModelDetectionRule::AnyKeyPresent {
        keys: COSMOS_GENERAL_DETECTION_MARKER_KEYS,
        score: 700,
    },
...
pub const MODEL_FAMILY: ModelFamilyDefinition = ModelFamilyDefinition {
    ...
    architecture_version: "cosmos-general-dit-i2v-v1",
...
pub const MODEL_FAMILY_REGISTRATION: ModelFamilyRegistration = ModelFamilyRegistration {
    ...
    source_ordinal: 42,
    source_architecture: "model_base.CosmosVideo(image_to_video=True)",
...
pub fn configuration_for_probe(
    probe: &ModelProbe,
) -> Result<CosmosI2VConfiguration, ModelFamilyError> {
