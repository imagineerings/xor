...
pub const MODEL_FAMILY_IDENTIFIER: &str = "Hunyuan3Dv2mini";
pub const MODEL_FAMILY_FEATURE_ID: &str = "COMFY-MODEL-0086";
pub const MODEL_FAMILY_FIXTURE: &str = "hunyuanthree-dv2mini-comfy-model-0086";
pub const MODEL_FAMILY_SOURCE_ORDINAL: u16 = 65;
...
pub const MODEL_FAMILY_PROJECTION_SHA256: &str =
    "9378d9c125a23e56a9c038544475b0e3fb615855412f1ee62ef0c167d2f10884";
...
const DETECTION_RULES: &[ModelDetectionRule] = &[
    ...
    ModelDetectionRule::AnyKeyPresent {
        keys: &[
            ...
            "model.double_blocks.7.img_attn.proj.weight",
...
fn select_profile(probe: &ModelProbe) -> Result<ModelFamilyProfile, ModelFamilyError> {
    ...
    if configuration.variant != Hunyuan3DVariant::V2Mini {
        return Err(ModelFamilyError::InvalidSelectorOutput(format!(
            "Hunyuan3Dv2mini row cannot admit {:?}",
