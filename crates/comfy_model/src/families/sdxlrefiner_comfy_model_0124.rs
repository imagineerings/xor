use crate::{
    ...
    ModelProbe, ModelWeightRule, SdxlConfiguration, SdxlVariant, sdxl_family,
};

pub const MODEL_FAMILY_IDENTIFIER: &str = "SDXLRefiner";
pub const MODEL_FAMILY_FEATURE_ID: &str = "COMFY-MODEL-0124";
pub const MODEL_FAMILY_FIXTURE: &str = "sdxlrefiner-comfy-model-0124";
pub const MODEL_FAMILY_SOURCE_ORDINAL: u16 = 8;
...
pub const MODEL_FAMILY_PROJECTION_SHA256: &str =
    "8abf95005dfad437b7c356363bf7800e61f4a98459b8624eb0fcb15cac9715d2";
pub const MODEL_FAMILY_MEMORY_USAGE_FACTOR: f64 =
    sdxl_family::SDXL_REFINER_MEMORY_USAGE_FACTOR;
pub const SOURCE_ARCHITECTURE: &str = "model_base.SDXLRefiner";
...
const DETECTION_RULES: &[ModelDetectionRule] = &[
    ModelDetectionRule::AnyTensorDimensionValue {
        keys: INPUT_KEYS,
        dimension: 0,
        values: &[sdxl_family::SDXL_REFINER_MODEL_CHANNELS],
        score: 250,
    },
    ModelDetectionRule::AnyTensorDimensionValue {
        keys: INPUT_KEYS,
    ...
    ModelDetectionRule::AnyTensorDimensionValue {
        keys: ADM_KEYS,
        dimension: 1,
        values: &[sdxl_family::SDXL_REFINER_ADM_INPUT_DIMENSION],
        score: 250,
    },
    ModelDetectionRule::AnyTensorDimensionValue {
        keys: DEEPEST_CONTEXT_KEYS,
        dimension: 1,
        values: &[sdxl_family::SDXL_REFINER_CONTEXT_DIMENSION],
        score: 350,
    },
];
...
pub const MODEL_FAMILY: ModelFamilyDefinition = ModelFamilyDefinition {
    ...
    architecture_version: "sdxl-refiner-v1",
    latent_feature_id: "COMFY-MODEL-0047",
    latent_identifier: "SDXL",
    clip_target: &sdxl_family::SDXL_REFINER_CLIP_TARGET,
...
pub const MODEL_FAMILY_REGISTRATION: ModelFamilyRegistration = ModelFamilyRegistration {
    ...
    clip_target_selector: ModelClipTargetSelector::Static(&sdxl_family::SDXL_REFINER_CLIP_TARGET),
...
pub fn configuration_for_probe(probe: &ModelProbe) -> Result<SdxlConfiguration, ModelFamilyError> {
    ...
    if configuration.variant != SdxlVariant::Refiner {
        return Err(ModelFamilyError::InvalidSelectorOutput(format!(
            "SDXLRefiner requires the source-exact 384-channel/depth-4 profile, found {:?}",
