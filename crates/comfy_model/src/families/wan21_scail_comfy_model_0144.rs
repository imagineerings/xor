use crate::{
    ...
    generated_wan21_t2v_comfy_model_0146::{
        FFN_WEIGHT, HEAD_MODULATION, HEAD_WEIGHT, PATCH_WEIGHT, POSE_PATCH_WEIGHT,
...
pub const MODEL_FAMILY_IDENTIFIER: &str = "WAN21_SCAIL";
pub const MODEL_FAMILY_FEATURE_ID: &str = "COMFY-MODEL-0144";
pub const MODEL_FAMILY_FIXTURE: &str = "wan21-scail-comfy-model-0144";
pub const MODEL_FAMILY_SOURCE_ORDINAL: u16 = 62;
...
pub const MODEL_FAMILY_PROJECTION_SHA256: &str =
    "1f2fcbb7811693997c7858ed908b177cf6dffa6dde2b82539727c3b458a884fe";
pub const MODEL_FAMILY_SHIFT: f64 = 8.0;
pub const SOURCE_ARCHITECTURE: &str = "model_base.WAN21_SCAIL";

const COMPONENTS: &[ModelFamilyComponent] = &[
    ModelFamilyComponent {
        identifier: "model",
        role: "Wan 2.1 SCAIL pose/reference-conditioned video transformer",
        required: true,
    },
    ModelFamilyComponent {
        identifier: "runtime_conditioning",
        role: "SCAIL pose/reference contract and source sampling shift",
        required: true,
    },
    ModelFamilyComponent {
...
const FORWARD_PROGRAM: &[ModelForwardStep] = &[
    ModelForwardStep {
        checkpoint: "scail_timestep_embedding",
    ...
    ModelForwardStep {
        checkpoint: "scail_pose_conditioning",
        operation: ModelForwardOperation::Silu,
    },
    ModelForwardStep {
        checkpoint: "scail_transformer_block",
        operation: ModelForwardOperation::Linear {
    ...
    ModelForwardStep {
        checkpoint: "scail_block_normalization",
    ...
    ModelForwardStep {
        checkpoint: "scail_head_projection",
        operation: ModelForwardOperation::Linear {
...
pub const MODEL_FAMILY: ModelFamilyDefinition = ModelFamilyDefinition {
    ...
    architecture_version: "wan21-scail-v1",
...
const COMPONENT_STATE_SCHEMAS: &[ModelFamilyComponentStateSchema] = &[
    ...
    ModelFamilyComponentStateSchema {
        ...
        required_keys: &["sampling_shift", "reference_conditioning", "pose_conditioning"],
        optional_keys: &[],
...
pub const MODEL_FAMILY_REGISTRATION: ModelFamilyRegistration = ModelFamilyRegistration {
    ...
    required_state_keys: &[POSE_PATCH_WEIGHT],
...
pub fn configuration_for_probe(
    ...
    if probe.select_layout(LAYOUT_SIGNATURES)? != ModelStateLayout::PrefixedNative {
        return Err(ModelFamilyError::InvalidSelectorOutput(
            "WAN21_SCAIL requires the source-native prefixed layout".to_owned(),
        ));
    }
    batch_configuration_for_probe(probe, Wan21BatchVariant::Scail)
}
