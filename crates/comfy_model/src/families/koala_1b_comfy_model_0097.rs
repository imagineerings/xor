use crate::{
    ...
    SDXL_KOALA_1B_TRANSFORMER_DEPTH, SDXL_LAYOUT_SIGNATURES, SDXL_LATENT_FORMAT,
...
pub const MODEL_FAMILY_IDENTIFIER: &str = "KOALA_1B";
pub const MODEL_FAMILY_FEATURE_ID: &str = "COMFY-MODEL-0097";
pub const MODEL_FAMILY_FIXTURE: &str = "koala-1b-comfy-model-0097";
pub const MODEL_FAMILY_SOURCE_ORDINAL: u16 = 12;
...
pub const MODEL_FAMILY_PROJECTION_SHA256: &str =
    "e74b2b1ce592ae51f9c21312af0ff80eb175afa419a21f1820eef1a9be88fd78";
...
const DETECTION_RULES: &[ModelDetectionRule] = &[
    ...
    ModelDetectionRule::AnyTensorFact {
        keys: &[
            "model.diffusion_model.input_blocks.5.1.transformer_blocks.5.attn2.to_k.weight",
            "input_blocks.5.1.transformer_blocks.5.attn2.to_k.weight",
...
fn select_profile(probe: &ModelProbe) -> Result<ModelFamilyProfile, ModelFamilyError> {
    ...
    if configuration.variant != SdxlVariant::Koala1B
        || configuration.transformer_depth != SDXL_KOALA_1B_TRANSFORMER_DEPTH
    {
        return Err(ModelFamilyError::InvalidSelectorOutput(format!(
            "KOALA_1B row cannot admit {:?}",
        ...
        || configuration.latent_format.identifier != SDXL_LATENT_FORMAT.identifier
    {
        return Err(ModelFamilyError::InvalidSelectorOutput(
            "KOALA_1B latent selection drifted".to_owned(),
        ));
    }
