...
pub use clip_text_encoder_decoder::{
    ...
    DecoderLayerKind, DecoderLayerWeights, DecoderPreparedGenerationOutcome,
    DecoderPreparedGenerationPrompt, DecoderPreparedTextRequest, DecoderProfileFact,
...
pub use clip_text_encoder_multimodal::{
    ...
    QWEN3VL_8B_DEEPSTACK_LAYERS, QWEN3VL_IMAGE_MAXIMUM_PIXELS, QWEN3VL_IMAGE_MINIMUM_PIXELS,
    QWEN3VL_IMAGE_PAD_TOKEN, QWEN3VL_IMAGE_PATCH_SIZE, QWEN3VL_IMAGE_SPATIAL_MERGE_SIZE,
    QWEN3VL_IMAGE_TEMPORAL_PATCH_SIZE, QWEN3VL_SOURCE_PATH, QWEN3VL_SOURCE_SHA256,
    Qwen3VlMarkerPlan, Qwen3VlPreparedImage, SAM3_CLIP_SOURCE_PATH, SAM3_CLIP_SOURCE_SHA256,
