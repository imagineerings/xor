...
pub use clip_text_encoder_multimodal::{
    ...
    Gemma3VisionConfiguration, Gemma3VisionProfile, Gemma3VisionProjection, GemmaPreparedAudio,
    ...
    NativeGemma3VisionProjector, NativeQwenMultimodal, NativeQwenVisionEncoder, OVIS_SOURCE_PATH,
