...
pub use clip_text_encoder_multimodal::{
    ...
    MultimodalTextOwner, NativeQwenVisionEncoder, OVIS_SOURCE_PATH, OVIS_SOURCE_SHA256,
    ...
    prepare_qwen_images, prepare_qwen3vl_images, qwen2vl_mrope_position_ids,
    qwen3vl_target_dimensions, run_bidirectional_text_owner, run_clip_text_owner,
