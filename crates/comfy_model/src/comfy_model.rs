...
pub use clip_text_encoder_multimodal::{
    ...
    Gemma3VisionProfile, Gemma3VisionProjection, Gemma4ClippedLinearWeights,
    Gemma4VisionBlockWeights, Gemma4VisionConfiguration, Gemma4VisionProfile,
    Gemma4VisionProjection, Gemma4VisionWeights, GemmaPreparedAudio, GemmaPreparedVisual,
    ...
    NativeGemma3VisionProjector, NativeGemma4VisionEncoder, NativeQwenMultimodal,
    NativeQwenVisionEncoder, OVIS_SOURCE_PATH, OVIS_SOURCE_SHA256,
