...
pub use clip_text_encoder_multimodal::{
    ...
    GemmaPreparedAudio, GemmaPreparedVisual, GemmaPreparedVisualKind, IDEOGRAM4_SOURCE_PATH,
    ...
    MultimodalTextOwner, NativeGemma3VisionProjector, NativeGemma4AudioEncoder,
    NativeGemma4VisionEncoder, NativeGemmaMultimodal, NativeQwenMultimodal,
