...
pub use clip_text_encoder_multimodal::{
    GEMMA3_IMAGE_AREA_PIXELS, GEMMA3_MAXIMUM_PREPARED_PIXELS, GEMMA4_AUDIO_FFT_LENGTH,
    ...
    MultimodalTextOwner, NativeQwenMultimodal, NativeQwenVisionEncoder, OVIS_SOURCE_PATH,
