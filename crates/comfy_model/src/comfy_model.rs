...
pub use clip_text_encoder_multimodal::{
    ...
    Gemma4VisionProfile, Gemma4VisionProjection, Gemma4VisionWeights, GemmaPreparedAudio,
    GemmaPreparedVisual, GemmaPreparedVisualKind, IDEOGRAM4_SOURCE_PATH, IDEOGRAM4_SOURCE_SHA256,
    IDEOGRAM4_TAP_LAYERS, JINA_CLIP2_SOURCE_PATH, JINA_CLIP2_SOURCE_SHA256,
    MULTIMODAL_PROFILE_FACTS, MULTIMODAL_TEXT_ENCODER_CATALOG_SYMBOLS, MultimodalDeepstackJoin,
    MultimodalFamily, MultimodalImageEmbedding, MultimodalPositionIds, MultimodalProfileFact,
    MultimodalSpan, MultimodalSymbolBehavior, MultimodalTextError, MultimodalTextOwner,
    NativeGemma3VisionProjector, NativeGemma4AudioEncoder, NativeGemma4VisionEncoder,
    NativeQwenMultimodal, NativeQwenVisionEncoder, OVIS_SOURCE_PATH, OVIS_SOURCE_SHA256,
    QWEN_MULTIMODAL_ROUTING_SOURCE_PATH, QWEN_MULTIMODAL_ROUTING_SOURCE_SHA256,
    ...
    Sam3Prompt, format_ideogram4_prompt, format_ovis_prompt, format_qwen3vl_prompt,
