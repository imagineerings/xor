...
pub use clip_text_encoder_decoder::{
    ...
    LLAMA_SOURCE_PATH, LLAMA_SOURCE_SHA256, NativeDecoderTextEncoder, NativeTextGenerationRequest,
    NativeTextGenerationResult, QWEN35_SOURCE_PATH, QWEN35_SOURCE_SHA256, Qwen35LinearCache,
    Qwen35LinearConfiguration, Qwen35LinearWeights, RopeScaling, TEXT_GENERATION_SOURCE_PATH,
    TEXT_GENERATION_SOURCE_SHA256, apply_rope, decoder_profile_fact, decoder_symbol_behavior,
    gemma3_decoder_configuration, gemma4_audio_conv2d_subsample, gemma4_audio_relative_positions,
