...
pub use clip_text_encoder_multimodal::{
    ...
    QwenVisionProjection, QwenVisionWeights, SAM3_CLIP_SOURCE_PATH, SAM3_CLIP_SOURCE_SHA256,
    Sam3ConditionPack, Sam3EncodedCondition, Sam3Prompt, format_ideogram4_prompt,
    format_ovis_prompt, format_qwen3vl_prompt, ideogram4_project_taps, join_multimodal_embeddings,
