...
// If the sim binary doesn't use anything in this crate, it will be optimized away
...
/// Opens a sim:// URL within the application.
#[derive(Clone, PartialEq, Deserialize, JsonSchema, Action)]
#[action(namespace = sim)]
#[serde(deny_unknown_fields)]
...
#[action(namespace = sim, no_json, no_register)]
...
actions!(
    ...
    [
        ...
        #[action(deprecated_aliases = ["sim_actions::OpenSettingsEditor"])]
        OpenSettings,
        /// Opens the settings JSON file.
        #[action(deprecated_aliases = ["sim_actions::OpenSettings"])]
        OpenSettingsFile,
        /// Opens project-specific settings.
        #[action(deprecated_aliases = ["sim_actions::OpenProjectSettings"])]
        OpenProjectSettings,
        /// Opens the default keymap file.
        OpenDefaultKeymap,
        /// Opens the user keymap file.
        #[action(deprecated_aliases = ["sim_actions::OpenKeymap"])]
        OpenKeymapFile,
        /// Opens the keymap editor.
        #[action(deprecated_aliases = ["sim_actions::OpenKeymapEditor"])]
        OpenKeymap,
...
pub struct CreateWorktree {
    /// When this is None, Sim will randomly generate a worktree name.
...
pub mod feedback {
    ...
    actions!(
        feedback,
        [
            /// Opens email client to send feedback to Sim support.
            EmailSim,
...
pub struct Rerun {
    ...
    /// If it is not, environment variables such as SIM_COLUMN, SIM_FILE are gonna be the same as in the last execution of a task
...
actions!(
    ...
    [
        /// Opens the Sim Predict onboarding modal.
