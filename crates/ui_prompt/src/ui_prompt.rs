...
pub struct BaymaxPromptRenderer {
    _level: PromptLevel,
...
impl Render for BaymaxPromptRenderer {
...
impl EventEmitter<PromptResponse> for BaymaxPromptRenderer {}

impl Focusable for BaymaxPromptRenderer {
