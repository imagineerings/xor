...
AppPublisher=Baymax Industries
AppPublisherURL=https://www.baymax.dev/
AppSupportURL=https://www.baymax.dev/
AppUpdatesURL=https://www.baymax.dev/
...
[Files]
Source: "{#ResourcesDir}\Baymax.exe"; DestDir: "{code:GetInstallDir}"; Flags: ignoreversion
...
; URI Scheme
Root: HKCU; Subkey: "Software\Classes\baymax"; ValueType: "string"; ValueData: "URL:baymax Protocol"; Flags: uninsdeletekey
Root: HKCU; Subkey: "Software\Classes\baymax"; ValueType: "string"; ValueName: "URL Protocol"; ValueData: ""
Root: HKCU; Subkey: "Software\Classes\baymax\DefaultIcon"; ValueType: "string"; ValueData: "{app}\Baymax.exe,1"
Root: HKCU; Subkey: "Software\Classes\baymax\shell\open\command"; ValueType: "string"; ValueData: """{app}\Baymax.exe"" ""%1"""
...
begin
  if WizardIsTaskSelected('addcontextmenufiles') then begin
    ShellExec('', 'powershell.exe', '-Command ' + AddQuotes('Add-AppxPackage -Path ''' + ExpandConstant('{app}\appx\baymax_explorer_command_injector.appx') + ''' -ExternalLocation ''' + ExpandConstant('{app}\appx') + ''''), '', SW_HIDE, ewWaitUntilTerminated, AddAppxPackageResultCode);
