...
//! Visual testing infrastructure for Baymax.
//!
//! This module provides utilities for visual regression testing of Baymax's UI.
//! It allows capturing screenshots of the real Baymax application window and comparing
...
//! cargo test -p baymax visual_tests -- --ignored --test-threads=1
//!
//! # Update baselines when UI intentionally changes
//! UPDATE_BASELINES=1 cargo test -p baymax visual_tests -- --ignored --test-threads=1
//! ```
//!
//! ## Screenshot Output
//!
...
/// Initialize a visual test context with all necessary Baymax subsystems.
...
mod tests {
    ...
    /// This test captures a screenshot of an empty Baymax workspace.
    ///
