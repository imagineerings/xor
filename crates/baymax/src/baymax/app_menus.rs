...
pub fn app_menus(cx: &mut App) -> Vec<Menu> {
    ...
    let mut view_items = vec![
        MenuItem::action(
            "Zoom In",
            baymax_actions::IncreaseBufferFontSize { persist: false },
        ),
        MenuItem::action(
            "Zoom Out",
            baymax_actions::DecreaseBufferFontSize { persist: false },
        ),
        MenuItem::action(
            "Reset Zoom",
            baymax_actions::ResetBufferFontSize { persist: false },
        ),
        MenuItem::action(
            "Reset All Zoom",
            baymax_actions::ResetAllZoom { persist: false },
        ),
        MenuItem::separator(),
        ...
        MenuItem::separator(),
        MenuItem::action("Project Panel", baymax_actions::project_panel::ToggleFocus),
    ...
    vec![
        Menu {
            ...
            disabled: false,
            items: vec![
                MenuItem::action("About Baymax", baymax_actions::About),
                MenuItem::action("Check for Updates", auto_update::Check),
                MenuItem::separator(),
                MenuItem::submenu(Menu::new("Settings").items([
                    MenuItem::action("Open Settings", baymax_actions::OpenSettings),
                    MenuItem::action("Open Settings File", super::OpenSettingsFile),
                    MenuItem::action("Open Project Settings", baymax_actions::OpenProjectSettings),
                    ...
                    MenuItem::action(
                        "Select Theme...",
                        baymax_actions::theme_selector::Toggle::default(),
                    ),
                    MenuItem::action(
                        "Select Icon Theme...",
                        baymax_actions::icon_theme_selector::Toggle::default(),
                    ),
                ])),
                MenuItem::separator(),
                #[cfg(target_os = "macos")]
                ...
                MenuItem::separator(),
                MenuItem::action("Extensions", baymax_actions::Extensions::default()),
                #[cfg(not(target_os = "windows"))]
                MenuItem::action("Install CLI", install_cli::InstallCliBinary),
                MenuItem::separator(),
                #[cfg(target_os = "macos")]
                MenuItem::action("Hide Baymax", super::Hide),
                #[cfg(target_os = "macos")]
                MenuItem::action("Hide Others", super::HideOthers),
                #[cfg(target_os = "macos")]
                MenuItem::action("Show All", super::ShowAll),
                MenuItem::separator(),
                MenuItem::action("Quit Baymax", Quit),
            ],
        },
        Menu {
            name: "File".into(),
            ...
            items: vec![
                ...
                MenuItem::action("Open Recent…", baymax_actions::OpenRecent::default()),
                MenuItem::action("Open Remote…", baymax_actions::OpenRemote::default()),
                MenuItem::separator(),
        ...
        Menu {
            ...
            items: vec![
                MenuItem::action(
                    "Spawn Task",
                    baymax_actions::Spawn::ViaModal {
                        reveal_target: None,
                    },
                ),
                MenuItem::action("Start Debugger", debugger_ui::Start),
                MenuItem::separator(),
                MenuItem::action("Edit tasks.json...", crate::baymax::OpenProjectTasks),
                MenuItem::action("Edit debug.json...", baymax_actions::OpenProjectDebugTasks),
                MenuItem::separator(),
        ...
        Menu {
            ...
            items: vec![
                ...
                MenuItem::action("View Telemetry", baymax_actions::OpenTelemetryLog),
                ...
                MenuItem::action(
                    "Documentation",
                    super::OpenBrowser {
                        url: "https://baymax.dev/docs".into(),
                    },
                ),
                MenuItem::action("Baymax Repository", feedback::OpenBaymaxRepo),
                MenuItem::action(
                    "Baymax Twitter",
                    super::OpenBrowser {
                        url: "https://twitter.com/baymaxdotdev".into(),
                    },
                ),
                MenuItem::action(
                    "Join the Team",
                    super::OpenBrowser {
                        url: "https://baymax.dev/jobs".into(),
                    },
                ),
            ],
        },
