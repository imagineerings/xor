use anyhow::Result;
use baymax_apps::{AppRegistry, ChatApp, ClockApp};
use gpui::{
...
actions!(
    apps_panel,
    [
        /// Toggles the Baymax Apps panel.
        Toggle,
        /// Toggles focus on the Baymax Apps panel.
        ToggleFocus
    ]
);

/// A workspace panel that hosts embedded baymax apps (chat, clock, etc.).
