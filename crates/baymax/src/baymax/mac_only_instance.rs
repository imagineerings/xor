...
fn instance_handshake() -> &'static str {
    match *release_channel::RELEASE_CHANNEL {
        ReleaseChannel::Dev => "Baymax Editor Dev Instance Running",
        ReleaseChannel::Nightly => "Baymax Editor Nightly Instance Running",
        ReleaseChannel::Preview => "Baymax Editor Preview Instance Running",
        ReleaseChannel::Stable => "Baymax Editor Stable Instance Running",
    }
}
