...
impl Motion {
    fn default_kind(&self) -> MotionKind {
        ...
        match self {
            ...
            | SneakBackward { .. }
            | Jump { .. }
            | SimSearchResult { .. } => MotionKind::Exclusive,
    ...
    pub fn move_point(
        ...
        let (new_point, goal) = match self {
            ...
            SimSearchResult { new_selections, .. } => {
...
fn up_down_buffer_rows(
    ...
    //
    // See: https://github.com/simtropolis/sim/issues/29134
