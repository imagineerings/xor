...
use baymax_actions::{OpenDocs, RevealTarget};
...
fn generate_commands(_: &App) -> Vec<VimCommand> {
    vec![
        ...
        VimCommand::new(("cq", "uit"), baymax_actions::Quit),
        VimCommand::new(
            ("bd", "elete"),
        ...
        VimCommand::str(("opt", "ions"), "baymax::OpenDefaultSettings"),
...
impl OnMatchingLines {
    // convert a vim query into something more usable by baymax.
