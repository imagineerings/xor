...
mod tests {
    ...
    fn test_parse_remote_url_given_ssh_url() {
        let parsed_remote = Gitee
            .parse_remote_url("git@gitee.com:simtropolis/zed.git")
            .unwrap();
    ...
    fn test_parse_remote_url_given_https_url() {
        let parsed_remote = Gitee
            .parse_remote_url("https://gitee.com/simtropolis/zed.git")
            .unwrap();
    ...
    fn test_build_gitee_permalink() {
        ...
        let expected_url = "https://gitee.com/simtropolis/zed/blob/e5fe811d7ad0fc26934edd76f891d20bdc3bb194/crates/editor/src/git/permalink.rs";
    ...
    fn test_build_gitee_permalink_with_single_line_selection() {
        ...
        let expected_url = "https://gitee.com/simtropolis/zed/blob/e5fe811d7ad0fc26934edd76f891d20bdc3bb194/crates/editor/src/git/permalink.rs#L7";
        assert_eq!(permalink.to_string(), expected_url.to_string())
    }
    ...
    fn test_build_gitee_permalink_with_multi_line_selection() {
        ...
        let expected_url = "https://gitee.com/simtropolis/zed/blob/e5fe811d7ad0fc26934edd76f891d20bdc3bb194/crates/editor/src/git/permalink.rs#L24-48";
        assert_eq!(permalink.to_string(), expected_url.to_string())
    }
}
