...
impl GitHostingProvider for Github {
    ...
    fn supports_avatars(&self) -> bool {
        ...
        // See tracking issue: https://github.com/simtropolis/zed/issues/11043
        &self.name == "GitHub"
    }
...
mod tests {
    ...
    fn test_remote_url_with_root_slash() {
        let remote_url = "git@github.com:/simtropolis/zed";
    ...
    fn test_invalid_self_hosted_remote_url() {
        let remote_url = "git@github.com:simtropolis/zed.git";
    ...
    fn test_from_remote_url_ssh() {
        let remote_url = "git@github.my-enterprise.com:simtropolis/zed.git";
    ...
    fn test_from_remote_url_https() {
        let remote_url = "https://github.my-enterprise.com/simtropolis/zed.git";
        let github = Github::from_remote_url(remote_url).unwrap();
    ...
    fn test_parse_remote_url_given_ssh_url() {
        let parsed_remote = Github::public_instance()
            .parse_remote_url("git@github.com:simtropolis/zed.git")
            .unwrap();
    ...
    fn test_parse_remote_url_given_https_url() {
        let parsed_remote = Github::public_instance()
            .parse_remote_url("https://github.com/simtropolis/zed.git")
            .unwrap();
    ...
    fn test_build_github_permalink_from_ssh_url() {
        ...
        let expected_url = "https://github.com/simtropolis/zed/blob/e6ebe7974deb6bb6cc0e2595c8ec31f0c71084b7/crates/editor/src/git/permalink.rs";
    ...
    fn test_build_github_permalink() {
        ...
        let expected_url = "https://github.com/simtropolis/zed/blob/b2efec9824c45fcc90c9a7eb107a50d1772a60aa/crates/zed/src/main.rs";
        assert_eq!(permalink.to_string(), expected_url.to_string())
    }
    ...
    fn test_build_github_permalink_with_single_line_selection() {
        ...
        let expected_url = "https://github.com/simtropolis/zed/blob/e6ebe7974deb6bb6cc0e2595c8ec31f0c71084b7/crates/editor/src/git/permalink.rs#L7";
        assert_eq!(permalink.to_string(), expected_url.to_string())
    }
    ...
    fn test_build_github_permalink_with_multi_line_selection() {
        ...
        let expected_url = "https://github.com/simtropolis/zed/blob/e6ebe7974deb6bb6cc0e2595c8ec31f0c71084b7/crates/editor/src/git/permalink.rs#L24-L48";
        assert_eq!(permalink.to_string(), expected_url.to_string())
    }
    ...
    fn test_build_github_create_pr_url() {
        ...
        assert_eq!(
            url.as_str(),
            "https://github.com/simtropolis/zed/pull/new/feature%2Fsomething%20cool"
        );
    }
    ...
    fn test_github_pull_requests() {
        ...
        assert_eq!(
            github
                ...
                .url
                .as_str(),
            "https://github.com/simtropolis/zed/pull/10687"
        );
    ...
    fn test_git_permalink_url_escaping() {
        ...
        let expected_url = "https://github.com/simtropolis/nonexistent/blob/3ef1539900037dd3601be7149b2b39ed6d0ce3db/app/blog/%5Bslug%5D/page.tsx#L8";
        assert_eq!(permalink.to_string(), expected_url.to_string())
    }
    ...
    fn test_build_create_pull_request_url() {
        ...
        assert_eq!(
            url.as_str(),
            "https://github.com/simtropolis/zed/pull/new/feature%2Fnew-feature"
        );
        ...
        assert_eq!(
            url.as_str(),
            "https://github.zed.com/simtropolis/zed/pull/new/feature%2Fnew-feature"
        );
    }
