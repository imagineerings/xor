...
impl Forgejo {
    ...
    async fn fetch_forgejo_commit_author(
        ...
        // see https://github.com/simtropolis/zed/issues/11043#issuecomment-3480446231
        if host == "codeberg.org"
...
mod tests {
    ...
    fn test_parse_remote_url_given_ssh_url() {
        let parsed_remote = Forgejo::public_instance()
            .parse_remote_url("git@codeberg.org:simtropolis/zed.git")
            .unwrap();
    ...
    fn test_parse_remote_url_given_https_url() {
        let parsed_remote = Forgejo::public_instance()
            .parse_remote_url("https://codeberg.org/simtropolis/zed.git")
            .unwrap();
    ...
    fn test_parse_remote_url_given_self_hosted_ssh_url() {
        let remote_url = "git@forgejo.my-enterprise.com:simtropolis/zed.git";
    ...
    fn test_parse_remote_url_given_self_hosted_https_url() {
        let remote_url = "https://forgejo.my-enterprise.com/simtropolis/zed.git";
        let parsed_remote = Forgejo::from_remote_url(remote_url)
            .unwrap()
            .parse_remote_url(remote_url)
            .unwrap();
    ...
    fn test_build_codeberg_permalink() {
        ...
        let expected_url = "https://codeberg.org/simtropolis/zed/src/commit/faa6f979be417239b2e070dbbf6392b909224e0b/crates/editor/src/git/permalink.rs";
    ...
    fn test_build_codeberg_permalink_with_single_line_selection() {
        ...
        let expected_url = "https://codeberg.org/simtropolis/zed/src/commit/faa6f979be417239b2e070dbbf6392b909224e0b/crates/editor/src/git/permalink.rs#L7";
        assert_eq!(permalink.to_string(), expected_url.to_string())
    }
    ...
    fn test_build_codeberg_permalink_with_multi_line_selection() {
        ...
        let expected_url = "https://codeberg.org/simtropolis/zed/src/commit/faa6f979be417239b2e070dbbf6392b909224e0b/crates/editor/src/git/permalink.rs#L24-L48";
        assert_eq!(permalink.to_string(), expected_url.to_string())
    }
    ...
    fn test_build_forgejo_self_hosted_permalink_from_ssh_url() {
        let forgejo =
            Forgejo::from_remote_url("git@forgejo.some-enterprise.com:simtropolis/zed.git")
                .unwrap();
        ...
        let expected_url = "https://forgejo.some-enterprise.com/simtropolis/zed/src/commit/e6ebe7974deb6bb6cc0e2595c8ec31f0c71084b7/crates/editor/src/git/permalink.rs";
        assert_eq!(permalink.to_string(), expected_url.to_string())
    }
    ...
    fn test_build_forgejo_self_hosted_permalink_from_https_url() {
        let forgejo =
            Forgejo::from_remote_url("https://forgejo-instance.big-co.com/simtropolis/zed.git")
                .unwrap();
        let permalink = forgejo.build_permalink(
            ParsedGitRemote {
                owner: "simtropolis".into(),
        ...
        let expected_url = "https://forgejo-instance.big-co.com/simtropolis/zed/src/commit/b2efec9824c45fcc90c9a7eb107a50d1772a60aa/crates/zed/src/main.rs";
        assert_eq!(permalink.to_string(), expected_url.to_string())
    }
}
