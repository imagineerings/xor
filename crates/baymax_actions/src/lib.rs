...
// If the baymax binary doesn't use anything in this crate, it will be optimized away
...
/// Opens a baymax:// URL within the application.
#[derive(Clone, PartialEq, Deserialize, JsonSchema, Action)]
#[action(namespace = baymax)]
#[serde(deny_unknown_fields)]
pub struct OpenBaymaxUrl {
    pub url: Arc<str>,
}
...
#[action(namespace = baymax, no_json, no_register)]
...
actions!(
    ...
    [
        ...
        #[action(deprecated_aliases = ["baymax_actions::OpenSettingsEditor"])]
        OpenSettings,
        /// Opens the settings JSON file.
        #[action(deprecated_aliases = ["baymax_actions::OpenSettings"])]
        OpenSettingsFile,
        /// Opens project-specific settings.
        #[action(deprecated_aliases = ["baymax_actions::OpenProjectSettings"])]
        OpenProjectSettings,
        /// Opens the default keymap file.
        OpenDefaultKeymap,
        /// Opens the user keymap file.
        #[action(deprecated_aliases = ["baymax_actions::OpenKeymap"])]
        OpenKeymapFile,
        /// Opens the keymap editor.
        #[action(deprecated_aliases = ["baymax_actions::OpenKeymapEditor"])]
        OpenKeymap,
        ...
        Quit,
        /// Shows information about Baymax.
        About,
        /// Opens the documentation website.
        OpenDocs,
        /// Views open source licenses.
        OpenLicenses,
        /// Opens the Baymax status page.
        OpenStatusPage,
...
pub struct CreateWorktree {
    /// When this is None, Baymax will randomly generate a worktree name.
...
pub mod feedback {
    ...
    actions!(
        feedback,
        [
            /// Opens email client to send feedback to Baymax support.
            EmailBaymax,
...
pub struct Rerun {
    ...
    /// If it is not, environment variables such as BAYMAX_COLUMN, BAYMAX_FILE are gonna be the same as in the last execution of a task
...
actions!(
    ...
    [
        /// Opens the Baymax Predict onboarding modal.
        OpenBaymaxPredictOnboarding
    ]
);
actions!(
    git_onboarding,
