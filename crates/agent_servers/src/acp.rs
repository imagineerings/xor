...
mod tests {
    ...
    #[test]
    fn client_capabilities_include_terminal_meta() {
...
fn handle_create_elicitation(
    ...
    match args.scope() {
        acp::ElicitationScope::Session(scope) => {
            ...
            let (_elicitation_id, task) = match thread
                .update(cx, |thread, cx| {
