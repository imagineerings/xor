...
impl EditPredictionDelegate for BaymaxEditPredictionDelegate {
    fn name() -> &'static str {
        "baymax-predict"
    }

    fn display_name() -> &'static str {
        "Baymax's Edit Predictions"
    }
