...
pub enum InvalidationStrategy {
    ...
    /// in addition to LSP capabilities, Baymax allows omitting certain hint kinds (defined by the corresponding LSP part: type/parameter/other) and toggling hints.
