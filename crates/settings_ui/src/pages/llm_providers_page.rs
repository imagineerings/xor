            ...
            h_flex()
                ...
                .child(
                    v_flex()
                        ...
                        .child(
                            Label::new(format!(
                                "Or set the {env_var_name} env var and restart Sim for it to take effect."
                            ))
...
fn get_or_create_configuration_view(
    ...
    let view = provider.configuration_view_v2(ConfigurationViewTargetAgent::SimAgent, window, cx);
