...
from sim_eval import config
from sim_eval.cli import build_parser
from sim_eval.launch import prepare_benchmark_suite, prepare_shared_build, prepare_suite
...
class LaunchPlanTests(unittest.TestCase):
    ...
    def test_explicit_existing_build_skips_source_preparation(self) -> None:
        ...
        with (
            ...
            patch("sim_eval.launch.build_ready_on_volume", return_value=True),
            patch("sim_eval.launch.resolve_source") as resolve_source,
        ):
    ...
    def test_explicit_missing_build_uses_from_source(self) -> None:
        ...
        with (
            patch("sim_eval.launch.build_ready_on_volume", return_value=False),
            patch("sim_eval.source.resolve_remote_ref", return_value="a" * 40),
        ):
            build_id, build_request = prepare_shared_build(args)
