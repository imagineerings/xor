...
fn instance_handshake() -> &'static str {
    match *release_channel::RELEASE_CHANNEL {
        ReleaseChannel::Dev => "Sim Editor Dev Instance Running",
        ReleaseChannel::Nightly => "Sim Editor Nightly Instance Running",
        ReleaseChannel::Preview => "Sim Editor Preview Instance Running",
        ReleaseChannel::Stable => "Sim Editor Stable Instance Running",
    }
}
