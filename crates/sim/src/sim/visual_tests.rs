...
//! Visual testing infrastructure for Sim.
//!
//! This module provides utilities for visual regression testing of Sim's UI.
//! It allows capturing screenshots of the real Sim application window and comparing
...
//! cargo test -p sim visual_tests -- --ignored --test-threads=1
//!
//! # Update baselines when UI intentionally changes
//! UPDATE_BASELINES=1 cargo test -p sim visual_tests -- --ignored --test-threads=1
//! ```
//!
//! ## Screenshot Output
//!
...
/// Initialize a visual test context with all necessary Sim subsystems.
...
mod tests {
    ...
    /// This test captures a screenshot of an empty Sim workspace.
    ///
