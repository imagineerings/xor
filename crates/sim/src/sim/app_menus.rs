...
pub fn app_menus(cx: &mut App) -> Vec<Menu> {
    ...
    let mut view_items = vec![
        MenuItem::action(
            "Zoom In",
            sim_actions::IncreaseBufferFontSize { persist: false },
        ),
        MenuItem::action(
            "Zoom Out",
            sim_actions::DecreaseBufferFontSize { persist: false },
        ),
        MenuItem::action(
            "Reset Zoom",
            sim_actions::ResetBufferFontSize { persist: false },
        ),
        MenuItem::action(
            "Reset All Zoom",
            sim_actions::ResetAllZoom { persist: false },
        ),
        MenuItem::separator(),
    ...
    vec![
        Menu {
            ...
            disabled: false,
            items: vec![
                MenuItem::action("About Sim", sim_actions::About),
                MenuItem::action("Check for Updates", auto_update::Check),
                MenuItem::separator(),
                MenuItem::submenu(Menu::new("Settings").items([
                    MenuItem::action("Open Settings", sim_actions::OpenSettings),
                    MenuItem::action("Open Settings File", super::OpenSettingsFile),
                    MenuItem::action("Open Project Settings", sim_actions::OpenProjectSettings),
                    ...
                    MenuItem::action(
                        "Select Theme...",
                        sim_actions::theme_selector::Toggle::default(),
                    ),
                    MenuItem::action(
                        "Select Icon Theme...",
                        sim_actions::icon_theme_selector::Toggle::default(),
                    ),
                ])),
                MenuItem::separator(),
                #[cfg(target_os = "macos")]
                ...
                MenuItem::separator(),
                MenuItem::action("Extensions", sim_actions::Extensions::default()),
                #[cfg(not(target_os = "windows"))]
                MenuItem::action("Install CLI", install_cli::InstallCliBinary),
                MenuItem::separator(),
                #[cfg(target_os = "macos")]
                MenuItem::action("Hide Sim", super::Hide),
                #[cfg(target_os = "macos")]
                MenuItem::action("Hide Others", super::HideOthers),
                #[cfg(target_os = "macos")]
                MenuItem::action("Show All", super::ShowAll),
                MenuItem::separator(),
                MenuItem::action("Quit Sim", Quit),
            ],
        },
        Menu {
            name: "File".into(),
            ...
            items: vec![
                ...
                MenuItem::action("Open Recent…", sim_actions::OpenRecent::default()),
                MenuItem::action("Open Remote…", sim_actions::OpenRemote::default()),
                MenuItem::separator(),
        ...
        Menu {
            ...
            items: vec![
                MenuItem::action(
                    "Spawn Task",
                    sim_actions::Spawn::ViaModal {
                        reveal_target: None,
                    },
                ),
                MenuItem::action("Start Debugger", debugger_ui::Start),
                MenuItem::separator(),
                MenuItem::action("Edit tasks.json...", crate::sim::OpenProjectTasks),
                MenuItem::action("Edit debug.json...", sim_actions::OpenProjectDebugTasks),
                MenuItem::separator(),
        ...
        Menu {
            ...
            items: vec![
                ...
                MenuItem::action("View Telemetry", sim_actions::OpenTelemetryLog),
                ...
                MenuItem::action(
                    "Documentation",
                    super::OpenBrowser {
                        url: "https://sim.dev/docs".into(),
                    },
                ),
                MenuItem::action("Sim Repository", feedback::OpenSimRepo),
                MenuItem::action(
                    "Sim Twitter",
                    super::OpenBrowser {
