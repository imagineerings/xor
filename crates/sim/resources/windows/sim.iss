...
AppPublisher=Sim Industries
AppPublisherURL=https://www.sim.dev/
AppSupportURL=https://www.sim.dev/
AppUpdatesURL=https://www.sim.dev/
...
[Files]
Source: "{#ResourcesDir}\Sim.exe"; DestDir: "{code:GetInstallDir}"; Flags: ignoreversion
...
; URI Scheme
Root: HKCU; Subkey: "Software\Classes\sim"; ValueType: "string"; ValueData: "URL:sim Protocol"; Flags: uninsdeletekey
Root: HKCU; Subkey: "Software\Classes\sim"; ValueType: "string"; ValueName: "URL Protocol"; ValueData: ""
Root: HKCU; Subkey: "Software\Classes\sim\DefaultIcon"; ValueType: "string"; ValueData: "{app}\Sim.exe,1"
Root: HKCU; Subkey: "Software\Classes\sim\shell\open\command"; ValueType: "string"; ValueData: """{app}\Sim.exe"" ""%1"""
...
begin
  if WizardIsTaskSelected('addcontextmenufiles') then begin
    ShellExec('', 'powershell.exe', '-Command ' + AddQuotes('Add-AppxPackage -Path ''' + ExpandConstant('{app}\appx\sim_explorer_command_injector.appx') + ''' -ExternalLocation ''' + ExpandConstant('{app}\appx') + ''''), '', SW_HIDE, ewWaitUntilTerminated, AddAppxPackageResultCode);
