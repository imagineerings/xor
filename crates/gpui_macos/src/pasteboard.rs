...
impl Pasteboard {
    ...
    unsafe fn new(inner: id) -> Self {
        Self {
            inner,
            text_hash_type: unsafe { ns_string("baymax-text-hash") },
            metadata_type: unsafe { ns_string("baymax-metadata") },
        }
    }
        ...
        unsafe {
            match item.entries.as_slice() {
                ...
                _ => {
                    ...
                    // https://github.com/simtropolis/baymax/blob/65f7412a0265552b06ce122655369d6cc7381dd6/crates/gpui/src/platform/mac/platform.rs#L1060-L1110
                    //
