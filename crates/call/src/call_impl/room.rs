...
impl Room {
                ...
                let client_reconnection = async {
                    ...
                    while remaining_attempts > 0 {
                        if client_status.borrow().is_connected() {
                            ...
                            if let Some(livekit_connection_info) = task.await.log_err() {
                                this.update(cx, |this, cx| {
                                    this.ensure_livekit_connection(livekit_connection_info, cx);
                                });
                                return true;
                            } else {
    ...
    fn rejoin(
        ...
        cx.spawn(async move |this, cx| {
            ...
            let livekit_connection_info = response.live_kit_connection_info.take();
            let room_proto = response.room.context("invalid room")?;
            this.update(cx, |this, cx| {
