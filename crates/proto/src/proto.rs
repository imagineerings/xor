...
messages!(
    ...
    (GetPendingJoinRequests, Background),
    (GetPendingJoinRequestsResponse, Background),
    ...
    (JoinRequestAdded, Foreground),
    (JoinRequestResponded, Foreground),
    ...
    (RequestJoinChannel, Background),
    (RequestJoinChannelResponse, Background),
    (RespondToJoinRequest, Background),
    (RespondToJoinRequestResponse, Background),
    ...
    (CreateGroupResponse, Foreground),
    (UpdateGroup, Foreground),
    (UpdateGroupResponse, Foreground),
    (DeleteGroup, Foreground),
    (DeleteGroupResponse, Foreground),
    (GetGroups, Background),
    (GetGroupsResponse, Background),
    (UpdateGroupMembers, Foreground),
    (UpdateGroupMembersResponse, Foreground),
    (LeaveGroup, Foreground),
    (LeaveGroupResponse, Foreground),
    ...
    (UrgentMessageNotification, Foreground),
    (UpdateGroups, Foreground),
...
request_messages!(
    ...
    (GetPendingJoinRequests, GetPendingJoinRequestsResponse),
    ...
    (RequestJoinChannel, RequestJoinChannelResponse),
    (RespondToJoinRequest, RespondToJoinRequestResponse),
