...
include!(concat!(env!("OUT_DIR"), "/sim.messages.rs"));
...
messages!(
    ...
    (Commit, Background),
    (ConfirmFileUpload, Background),
    (ConfirmFileUploadResponse, Background),
    (GetFileDownloadUrl, Background),
    (GetFileDownloadUrlResponse, Background),
    (RunGitHook, Background),
    (ScheduleChannelMessage, Background),
    (ScheduleChannelMessageResponse, Background),
    (SearchChannelMessages, Background),
    (SearchChannelMessagesResponse, Background),
    ...
    (GetBookmarks, Background),
    (GetBookmarksResponse, Background),
    (GetFileUploadUrl, Background),
    (GetFileUploadUrlResponse, Background),
    (GetScheduledMessages, Background),
    (GetScheduledMessagesResponse, Background),
    (GetThread, Background),
    (GetThreadResponse, Background),
    (GetThreads, Background),
    (GetThreadsResponse, Background),
    ...
    (UpdateBookmark, Background),
    (UpdateChannelBuffer, Foreground),
    (UpdateChannelBufferCollaborators, Foreground),
    (UpdateChannelBookmarks, Foreground),
...
request_messages!(
    ...
    (Call, Ack),
    (CancelCall, Ack),
    (CancelScheduledMessage, Ack),
    (Commit, Ack),
    (ConfirmFileUpload, ConfirmFileUploadResponse),
    (RunGitHook, Ack),
    ...
    (SearchChannelMessages, SearchChannelMessagesResponse),
    (ScheduleChannelMessage, ScheduleChannelMessageResponse),
    (UpdateScheduledMessage, Ack),
    (GetScheduledMessages, GetScheduledMessagesResponse),
    (GetBookmarks, GetBookmarksResponse),
    (GetFileUploadUrl, GetFileUploadUrlResponse),
    (GetFileDownloadUrl, GetFileDownloadUrlResponse),
    (GetThread, GetThreadResponse),
    (GetThreads, GetThreadsResponse),
