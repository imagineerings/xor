use crate::{
    ...
    db::{
        Database,
        join_request_store::{ExpiredJoinRequest, JoinRequestStore},
    },
};
...
pub async fn expire_join_requests(db: Arc<Database>) -> Result<Vec<ExpiredJoinRequest>> {
...
pub async fn expire_join_requests_with_ttl(
    db: Arc<Database>,
    ttl: time::Duration,
