...
$Volume = New-VHD -Path C:/baymax_dev_drive.vhdx -SizeBytes 100GB |
                    Mount-VHD -Passthru |
...
Dismount-VHD -Path C:/baymax_dev_drive.vhdx
Mount-VHD -Path C:/baymax_dev_drive.vhdx
