...
- [ ] 10. Write tests
  ...
  - _implemented initial client/server integration coverage in `crates/collab/tests/integration/channel_chat_tests.rs`; full-flow, thread compose, and realtime open-thread UI coverage in `crates/collab/tests/integration/channel_chat_ui_tests.rs`; direct DB unit and unread/read UI tests remain_
