...
- [ ] 1. Define reaction proto messages
  ...
  - _writes: crates/proto/src/proto/requests.proto_

- [ ] 2. Regenerate Rust protobuf types
  ...
  - _Requirements: 2.1, 2.4_
  - _writes: crates/proto/src/structs.rs (autogenerated, committed)_
