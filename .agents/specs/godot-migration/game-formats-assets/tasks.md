...
- W2 Baymax game compatibility substrate: text format parsing and `.import` metadata linking can start after G2.
...
- [ ] 1. Implement Godot format parsing and generated asset registration
  ...
  - _writes: crates/baymax_game/src/formats.rs, crates/baymax_game/src/imports.rs, crates/baymax_game/src/generated_assets.rs_
