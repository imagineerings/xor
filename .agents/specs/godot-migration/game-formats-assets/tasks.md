...
- [ ] 1. Implement Godot format parsing and generated asset registration
  ...
  - Represent parsing, import linking, caches, dependencies, and generated mesh registration through existing Sim project, worktree, filesystem, preview, media, and artifact owners.
  ...
  - _Depends on: none_
  - _Reads: /Users/ahmad.vegah/repos/sim/.agents/specs/godot-migration/game-formats-assets/requirements.md, /Users/ahmad.vegah/repos/sim/.agents/specs/godot-migration/game-formats-assets/design.md, Cargo.toml, projects/godot_
  - _Validation: python3 .agents/skills/feature-spec/scripts/validate_spec.py /Users/ahmad.vegah/repos/sim/.agents/specs/godot-migration/game-formats-assets; run import, cache, dependency, failure, cancellation, and recovery scenarios without Godot and inspect outputs/processes/loaders/dependencies_

- [ ] 2. Prove import outputs are Sim-native without Godot
  ...
  - _Validation: execute every supported importer on a machine without Godot; assert outputs are Sim-native and no Godot process, library, server, CLI, hidden instance, or dependency exists_
