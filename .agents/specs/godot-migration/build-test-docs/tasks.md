...
- [ ] 1. Add docs, fixture attribution, and dependency review helpers
  ...
  - _Depends on: none_
  - _Reads: /Users/ahmad.vegah/repos/sim/.agents/specs/godot-migration/build-test-docs/requirements.md, /Users/ahmad.vegah/repos/sim/.agents/specs/godot-migration/build-test-docs/design.md, Cargo.toml, projects/godot_
  - _Validation: python3 .agents/skills/feature-spec/scripts/validate_spec.py /Users/ahmad.vegah/repos/sim/.agents/specs/godot-migration/build-test-docs; run build/test/docs/license/dependency checks without Godot and inspect process, package, loader, and dependency graphs_
...
- [ ] 2. Prove Godot remains evidence-only and unlinked
  ...
  - _Validation: execute Sim build/test/docs/compliance/package checks on a machine without Godot and assert zero unapproved copied material, Godot process, library, server, CLI, linkage, or runtime dependency_
