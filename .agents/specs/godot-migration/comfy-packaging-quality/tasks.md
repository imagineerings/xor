...
Build cross-cutting migration controls that other Comfy specs depend on: launch profile parsing, feature flags, schema catalog, compatibility fixtures, dependency gates, packaging profiles, and diagnostics. Comfy-compatible inputs are parsed into native Zed records; Zed-owned implementation modules and types use `Zed*` names rather than `Comfy*` pass-through labels.

## Gates

- Start gate: G0 spec consistency, G7 dependency review policy, and G8 Comfy harness alignment, G9 Zed coverage are satisfied.
...
- [ ] 1. Implement Comfy launch profile parser
  ...
  - _Writes: crates/world_model/src/zed_launch_profile.rs, crates/world_model/src/zed_launch_profile_tests.rs_
  - _CoverageOwner: .agents/specs/godot-migration/comfy-packaging-quality_
  - _Depends on: none_
  - _Reads: /Users/ahmad.vegah/repos/zed/.agents/specs/godot-migration/comfy-packaging-quality/requirements.md, /Users/ahmad.vegah/repos/zed/.agents/specs/godot-migration/comfy-packaging-quality/design.md, Cargo.toml, projects/comfy_
  - _Validation: python3 .agents/skills/feature-spec/scripts/validate_spec.py /Users/ahmad.vegah/repos/zed/.agents/specs/godot-migration/comfy-packaging-quality_
- [ ] 2. Implement feature flag registry
  ...
  - Report missing or outdated frontend, workflow template, and embedded docs packages with actionable Zed diagnostics.
  ...
  - _Writes: crates/world_model/src/zed_feature_flags.rs, crates/world_model/src/zed_feature_flags_tests.rs_
  - _CoverageOwner: .agents/specs/godot-migration/comfy-packaging-quality_
  - _Depends on: 1_
  - _Reads: /Users/ahmad.vegah/repos/zed/.agents/specs/godot-migration/comfy-packaging-quality/requirements.md, /Users/ahmad.vegah/repos/zed/.agents/specs/godot-migration/comfy-packaging-quality/design.md, Cargo.toml, projects/comfy_
  - _Validation: python3 .agents/skills/feature-spec/scripts/validate_spec.py /Users/ahmad.vegah/repos/zed/.agents/specs/godot-migration/comfy-packaging-quality_
- [ ] 3. Implement API schema support catalog
  ...
  - Derive implemented route coverage from Zed-owned route handlers, require schema refs for implemented routes, and require reasons for planned/cloud-only/external/unsupported routes.
  ...
  - _Writes: crates/world_model/src/zed_api_schema.rs, crates/world_model/fixtures/comfy/api_routes.json, crates/world_model/src/zed_api_schema_tests.rs_
  - _CoverageOwner: .agents/specs/godot-migration/comfy-packaging-quality_
  - _Depends on: 2_
  - _Reads: /Users/ahmad.vegah/repos/zed/.agents/specs/godot-migration/comfy-packaging-quality/requirements.md, /Users/ahmad.vegah/repos/zed/.agents/specs/godot-migration/comfy-packaging-quality/design.md, Cargo.toml, projects/comfy_
  - _Validation: python3 .agents/skills/feature-spec/scripts/validate_spec.py /Users/ahmad.vegah/repos/zed/.agents/specs/godot-migration/comfy-packaging-quality_
- [ ] 4. Build compatibility fixture suite
  ...
  - Aggregate implemented fixture groups through native Zed records and document future provider/media fixture ownership without treating missing future groups as ComfyUI pass-through coverage.
...
- [ ] 5. Implement dependency review gate
  ...
  - _Writes: crates/world_model/src/zed_dependency_review.rs, crates/world_model/src/zed_dependency_review_tests.rs_
  - _CoverageOwner: .agents/specs/godot-migration/comfy-packaging-quality_
  - _Depends on: 4_
  - _Reads: /Users/ahmad.vegah/repos/zed/.agents/specs/godot-migration/comfy-packaging-quality/requirements.md, /Users/ahmad.vegah/repos/zed/.agents/specs/godot-migration/comfy-packaging-quality/design.md, Cargo.toml, projects/comfy_
  - _Validation: python3 .agents/skills/feature-spec/scripts/validate_spec.py /Users/ahmad.vegah/repos/zed/.agents/specs/godot-migration/comfy-packaging-quality_
- [ ] 6. Add packaging profile catalog
  ...
  - Represent catalog entries with native `SimPackagingProfile*` records and keep installer/platform packaging delegated to existing Zed systems.
  - _Requirements: 5.2_
  - _Writes: crates/world_model/src/zed_packaging_profiles.rs, crates/world_model/src/zed_packaging_profiles_tests.rs_
  - _CoverageOwner: .agents/specs/godot-migration/comfy-packaging-quality_
  - _Depends on: 5_
  - _Reads: /Users/ahmad.vegah/repos/zed/.agents/specs/godot-migration/comfy-packaging-quality/requirements.md, /Users/ahmad.vegah/repos/zed/.agents/specs/godot-migration/comfy-packaging-quality/design.md, Cargo.toml, projects/comfy_
  - _Validation: python3 .agents/skills/feature-spec/scripts/validate_spec.py /Users/ahmad.vegah/repos/zed/.agents/specs/godot-migration/comfy-packaging-quality_
- [ ] 7. Implement logs and internal diagnostics adapter
  - Expose formatted/raw logs, terminal size metadata, approved folder paths, and recent input/output/temp files through Zed diagnostics.
  ...
  - _Writes: crates/world_model/src/zed_diagnostics_adapter.rs, crates/world_model/src/zed_diagnostics_adapter_tests.rs_
  - _CoverageOwner: .agents/specs/godot-migration/comfy-packaging-quality_
  - _Depends on: 6_
  - _Reads: /Users/ahmad.vegah/repos/zed/.agents/specs/godot-migration/comfy-packaging-quality/requirements.md, /Users/ahmad.vegah/repos/zed/.agents/specs/godot-migration/comfy-packaging-quality/design.md, Cargo.toml, projects/comfy_
  - _Validation: python3 .agents/skills/feature-spec/scripts/validate_spec.py /Users/ahmad.vegah/repos/zed/.agents/specs/godot-migration/comfy-packaging-quality_
- [ ] 8. Materialize remaining packaging and quality coverage backlog
  - Convert 683 planned coverage records in packaging-quality into native Zed implementation, delegation, unsupported, or divergent outcomes without ComfyUI pass-through.
  ...
  - Native Zed writes: crates/world_model/src/zed_packaging_profiles.rs, crates/world_model/src/world_model.rs, crates/world_model/tests/comfy_compat_suite.rs, crates/world_model/fixtures/comfy/coverage_ledger.json, crates/world_model/fixtures/comfy/packaging_quality_backlog.json.
  - Validation: `cargo test -p world_model --test comfy_compat_suite`.
  - Parity evidence: Records are implemented only with native Zed launch, feature flag, schema, fixture, dependency review, packaging, or diagnostics evidence; package and release surfaces remain metadata-only and review-gated where required.
  - _CoverageTask: coverage-backlog-packaging-quality_
  - _CoverageOwner: .agents/specs/godot-migration/comfy-packaging-quality_
  - _Requirements: 9.1, 9.2, 9.3, 9.4_
  - _Writes: crates/world_model/src/zed_packaging_profiles.rs, crates/world_model/src/world_model.rs, crates/world_model/tests/comfy_compat_suite.rs, crates/world_model/fixtures/comfy/coverage_ledger.json, crates/world_model/fixtures/comfy/packaging_quality_backlog.json
  - _Depends on: 7_
  - _Reads: /Users/ahmad.vegah/repos/zed/.agents/specs/godot-migration/comfy-packaging-quality/requirements.md, /Users/ahmad.vegah/repos/zed/.agents/specs/godot-migration/comfy-packaging-quality/design.md, Cargo.toml, projects/comfy_
  - _Validation: python3 .agents/skills/feature-spec/scripts/validate_spec.py /Users/ahmad.vegah/repos/zed/.agents/specs/godot-migration/comfy-packaging-quality_
