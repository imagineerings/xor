...
- [ ] 76. Close or verify GODOT-SIM-001: simulate 2D rigid, static, character, animatable, and soft bodies with areas, shapes, joints, layers, masks, sleeping, and callbacks
  - Apply the cataloged native Sim owner, reuse strategy, modes, failure/recovery, storage, execution, UI, persistence, lifecycle, security, limit, compatibility boundary, and platform contract. Classification remains historical; implementation may claim completion only with connected Sim behavior and hermetic no-Godot evidence.
  ...
  - _Writes: crates/project/src/project.rs#GODOT-SIM-001, crates/task/src/task.rs#GODOT-SIM-001, crates/audio/src/audio.rs#GODOT-SIM-001, crates/media/src/media.rs#GODOT-SIM-001_
  - _Validation: cargo test -p project -p task -p audio godot_simulation; run the SIM scenario for simulate 2D rigid, static, character, animatable, and soft bodies with areas, shapes, joints, layers, masks, sleeping, and callbacks in a hermetic environment with Godot absent from PATH, loader paths, installed applications, package contents, and process allowlists; inspect the process tree and linked/runtime dependency manifests and assert that no Godot executable, shared library, server, command-line tool, or hidden instance is discovered, loaded, or invoked._

- [ ] 77. Close or verify GODOT-SIM-002: simulate 3D rigid, static, character, animatable, and soft bodies with areas, shapes, joints, layers, masks, sleeping, and callbacks
  - Apply the cataloged native Sim owner, reuse strategy, modes, failure/recovery, storage, execution, UI, persistence, lifecycle, security, limit, compatibility boundary, and platform contract. Classification remains historical; implementation may claim completion only with connected Sim behavior and hermetic no-Godot evidence.
  - _Requirements: 9.1, 9.2, 9.3, 9.4, 23.1, 23.2, 23.3, 23.4, 23.5, 23.6, 23.7, 23.8, 23.9, 23.10_
  - _Depends on: 76, 200_
  - _Reads: projects/godot/servers/physics_2d/physics_server_2d.cpp, Cargo.toml, .agents/specs/godot-migration/godot-full-port-coverage/catalogs/master-coverage.csv_
  - _Writes: crates/project/src/project.rs#GODOT-SIM-002, crates/task/src/task.rs#GODOT-SIM-002, crates/audio/src/audio.rs#GODOT-SIM-002, crates/media/src/media.rs#GODOT-SIM-002_
  - _Validation: cargo test -p project -p task -p audio godot_simulation; run the SIM scenario for simulate 3D rigid, static, character, animatable, and soft bodies with areas, shapes, joints, layers, masks, sleeping, and callbacks in a hermetic environment with Godot absent from PATH, loader paths, installed applications, package contents, and process allowlists; inspect the process tree and linked/runtime dependency manifests and assert that no Godot executable, shared library, server, command-line tool, or hidden instance is discovered, loaded, or invoked._

- [ ] 78. Close or verify GODOT-SIM-003: select Godot Physics or Jolt 3D and report backend-specific settings and unsupported behavior
  - Apply the cataloged native Sim owner, reuse strategy, modes, failure/recovery, storage, execution, UI, persistence, lifecycle, security, limit, compatibility boundary, and platform contract. Classification remains historical; implementation may claim completion only with connected Sim behavior and hermetic no-Godot evidence.
  - _Requirements: 9.1, 9.2, 9.3, 9.4, 23.1, 23.2, 23.3, 23.4, 23.5, 23.6, 23.7, 23.8, 23.9, 23.10_
  - _Depends on: 77, 200_
  - _Reads: projects/godot/servers/physics_2d/physics_server_2d.cpp, Cargo.toml, .agents/specs/godot-migration/godot-full-port-coverage/catalogs/master-coverage.csv_
  - _Writes: crates/project/src/project.rs#GODOT-SIM-003, crates/task/src/task.rs#GODOT-SIM-003, crates/audio/src/audio.rs#GODOT-SIM-003, crates/media/src/media.rs#GODOT-SIM-003_
  - _Validation: cargo test -p project -p task -p audio godot_simulation; run the SIM scenario for select Godot Physics or Jolt 3D and report backend-specific settings and unsupported behavior in a hermetic environment with Godot absent from PATH, loader paths, installed applications, package contents, and process allowlists; inspect the process tree and linked/runtime dependency manifests and assert that no Godot executable, shared library, server, command-line tool, or hidden instance is discovered, loaded, or invoked._

- [ ] 79. Close or verify GODOT-SIM-004: perform direct-space point, ray, shape, motion, contact, and rest-info queries with exclusions and limits
  - Apply the cataloged native Sim owner, reuse strategy, modes, failure/recovery, storage, execution, UI, persistence, lifecycle, security, limit, compatibility boundary, and platform contract. Classification remains historical; implementation may claim completion only with connected Sim behavior and hermetic no-Godot evidence.
  - _Requirements: 9.1, 9.2, 9.3, 9.4, 23.1, 23.2, 23.3, 23.4, 23.5, 23.6, 23.7, 23.8, 23.9, 23.10_
  - _Depends on: 78, 200_
  - _Reads: projects/godot/servers/physics_2d/physics_server_2d.cpp, Cargo.toml, .agents/specs/godot-migration/godot-full-port-coverage/catalogs/master-coverage.csv_
  - _Writes: crates/project/src/project.rs#GODOT-SIM-004, crates/task/src/task.rs#GODOT-SIM-004, crates/audio/src/audio.rs#GODOT-SIM-004, crates/media/src/media.rs#GODOT-SIM-004_
  - _Validation: cargo test -p project -p task -p audio godot_simulation; run the SIM scenario for perform direct-space point, ray, shape, motion, contact, and rest-info queries with exclusions and limits in a hermetic environment with Godot absent from PATH, loader paths, installed applications, package contents, and process allowlists; inspect the process tree and linked/runtime dependency manifests and assert that no Godot executable, shared library, server, command-line tool, or hidden instance is discovered, loaded, or invoked._

- [ ] 80. Close or verify GODOT-SIM-005: build navigation maps from regions, meshes, links, obstacles, costs, layers, and avoidance agents in 2D and 3D
  - Apply the cataloged native Sim owner, reuse strategy, modes, failure/recovery, storage, execution, UI, persistence, lifecycle, security, limit, compatibility boundary, and platform contract. Classification remains historical; implementation may claim completion only with connected Sim behavior and hermetic no-Godot evidence.
  - _Requirements: 9.1, 9.2, 9.3, 9.4, 23.1, 23.2, 23.3, 23.4, 23.5, 23.6, 23.7, 23.8, 23.9, 23.10_
  - _Depends on: 79, 200_
  - _Reads: projects/godot/servers/physics_2d/physics_server_2d.cpp, Cargo.toml, .agents/specs/godot-migration/godot-full-port-coverage/catalogs/master-coverage.csv_
  - _Writes: crates/project/src/project.rs#GODOT-SIM-005, crates/task/src/task.rs#GODOT-SIM-005, crates/audio/src/audio.rs#GODOT-SIM-005, crates/media/src/media.rs#GODOT-SIM-005_
  - _Validation: cargo test -p project -p task -p audio godot_simulation; run the SIM scenario for build navigation maps from regions, meshes, links, obstacles, costs, layers, and avoidance agents in 2D and 3D in a hermetic environment with Godot absent from PATH, loader paths, installed applications, package contents, and process allowlists; inspect the process tree and linked/runtime dependency manifests and assert that no Godot executable, shared library, server, command-line tool, or hidden instance is discovered, loaded, or invoked._

- [ ] 81. Close or verify GODOT-SIM-006: bake, parse, cache, update, and debug navigation meshes and source geometry asynchronously with cancellation
  - Apply the cataloged native Sim owner, reuse strategy, modes, failure/recovery, storage, execution, UI, persistence, lifecycle, security, limit, compatibility boundary, and platform contract. Classification remains historical; implementation may claim completion only with connected Sim behavior and hermetic no-Godot evidence.
  - _Requirements: 9.1, 9.2, 9.3, 9.4, 23.1, 23.2, 23.3, 23.4, 23.5, 23.6, 23.7, 23.8, 23.9, 23.10_
  - _Depends on: 80, 200_
  - _Reads: projects/godot/servers/physics_2d/physics_server_2d.cpp, Cargo.toml, .agents/specs/godot-migration/godot-full-port-coverage/catalogs/master-coverage.csv_
  - _Writes: crates/project/src/project.rs#GODOT-SIM-006, crates/task/src/task.rs#GODOT-SIM-006, crates/audio/src/audio.rs#GODOT-SIM-006, crates/media/src/media.rs#GODOT-SIM-006_
  - _Validation: cargo test -p project -p task -p audio godot_simulation; run the SIM scenario for bake, parse, cache, update, and debug navigation meshes and source geometry asynchronously with cancellation in a hermetic environment with Godot absent from PATH, loader paths, installed applications, package contents, and process allowlists; inspect the process tree and linked/runtime dependency manifests and assert that no Godot executable, shared library, server, command-line tool, or hidden instance is discovered, loaded, or invoked._

- [ ] 82. Close or verify GODOT-SIM-007: author and play Animation, AnimationPlayer, AnimationTree, Tween, tracks, blends, state machines, method/audio tracks, and root motion
  - Apply the cataloged native Sim owner, reuse strategy, modes, failure/recovery, storage, execution, UI, persistence, lifecycle, security, limit, compatibility boundary, and platform contract. Classification remains historical; implementation may claim completion only with connected Sim behavior and hermetic no-Godot evidence.
  - _Requirements: 9.1, 9.2, 9.3, 9.4, 23.1, 23.2, 23.3, 23.4, 23.5, 23.6, 23.7, 23.8, 23.9, 23.10_
  - _Depends on: 81, 200_
  - _Reads: projects/godot/servers/physics_2d/physics_server_2d.cpp, Cargo.toml, .agents/specs/godot-migration/godot-full-port-coverage/catalogs/master-coverage.csv_
  - _Writes: crates/project/src/project.rs#GODOT-SIM-007, crates/task/src/task.rs#GODOT-SIM-007, crates/audio/src/audio.rs#GODOT-SIM-007, crates/media/src/media.rs#GODOT-SIM-007_
  - _Validation: cargo test -p project -p task -p audio godot_simulation; run the SIM scenario for author and play Animation, AnimationPlayer, AnimationTree, Tween, tracks, blends, state machines, method/audio tracks, and root motion in a hermetic environment with Godot absent from PATH, loader paths, installed applications, package contents, and process allowlists; inspect the process tree and linked/runtime dependency manifests and assert that no Godot executable, shared library, server, command-line tool, or hidden instance is discovered, loaded, or invoked._

- [ ] 83. Close or verify GODOT-SIM-008: route sample playback through buses, sends, effects, capture, device switching, spatial emitters, polyphony, and interactive music
  - Apply the cataloged native Sim owner, reuse strategy, modes, failure/recovery, storage, execution, UI, persistence, lifecycle, security, limit, compatibility boundary, and platform contract. Classification remains historical; implementation may claim completion only with connected Sim behavior and hermetic no-Godot evidence.
  - _Requirements: 9.1, 9.2, 9.3, 9.4, 23.1, 23.2, 23.3, 23.4, 23.5, 23.6, 23.7, 23.8, 23.9, 23.10_
  - _Depends on: 82, 200_
  - _Reads: projects/godot/servers/physics_2d/physics_server_2d.cpp, Cargo.toml, .agents/specs/godot-migration/godot-full-port-coverage/catalogs/master-coverage.csv_
  - _Writes: crates/project/src/project.rs#GODOT-SIM-008, crates/task/src/task.rs#GODOT-SIM-008, crates/audio/src/audio.rs#GODOT-SIM-008, crates/media/src/media.rs#GODOT-SIM-008_
  - _Validation: cargo test -p project -p task -p audio godot_simulation; run the SIM scenario for route sample playback through buses, sends, effects, capture, device switching, spatial emitters, polyphony, and interactive music in a hermetic environment with Godot absent from PATH, loader paths, installed applications, package contents, and process allowlists; inspect the process tree and linked/runtime dependency manifests and assert that no Godot executable, shared library, server, command-line tool, or hidden instance is discovered, loaded, or invoked._

- [ ] 84. Close or verify GODOT-SIM-009: simulate CPU and GPU particles, trails, collisions, attractors, process materials, subemitters, fixed FPS, and restart state
  - Apply the cataloged native Sim owner, reuse strategy, modes, failure/recovery, storage, execution, UI, persistence, lifecycle, security, limit, compatibility boundary, and platform contract. Classification remains historical; implementation may claim completion only with connected Sim behavior and hermetic no-Godot evidence.
  - _Requirements: 9.1, 9.2, 9.3, 9.4, 23.1, 23.2, 23.3, 23.4, 23.5, 23.6, 23.7, 23.8, 23.9, 23.10_
  - _Depends on: 83, 200_
  - _Reads: projects/godot/servers/physics_2d/physics_server_2d.cpp, Cargo.toml, .agents/specs/godot-migration/godot-full-port-coverage/catalogs/master-coverage.csv_
  - _Writes: crates/project/src/project.rs#GODOT-SIM-009, crates/task/src/task.rs#GODOT-SIM-009, crates/audio/src/audio.rs#GODOT-SIM-009, crates/media/src/media.rs#GODOT-SIM-009_
  - _Validation: cargo test -p project -p task -p audio godot_simulation; run the SIM scenario for simulate CPU and GPU particles, trails, collisions, attractors, process materials, subemitters, fixed FPS, and restart state in a hermetic environment with Godot absent from PATH, loader paths, installed applications, package contents, and process allowlists; inspect the process tree and linked/runtime dependency manifests and assert that no Godot executable, shared library, server, command-line tool, or hidden instance is discovered, loaded, or invoked._
...
- [ ] 101. Close or verify GODOT-EXT-008: reuse Sim extension trust, capability, installation, and UI boundaries instead of creating a second plugin manager
  - Apply the cataloged native Sim owner, reuse strategy, modes, failure/recovery, storage, execution, UI, persistence, lifecycle, security, limit, compatibility boundary, and platform contract. Classification remains historical; implementation may claim completion only with connected Sim behavior and hermetic no-Godot evidence.
  - _Requirements: 11.1, 11.2, 11.3, 11.4, 23.1, 23.2, 23.3, 23.4, 23.5, 23.6, 23.7, 23.8, 23.9, 23.10_
  ...
  - _Validation: cargo test -p extension -p extension_host -p extensions_ui godot; run the EXT scenario for reuse Sim extension trust, capability, installation, and UI boundaries instead of creating a second plugin manager in a hermetic environment with Godot absent from PATH, loader paths, installed applications, package contents, and process allowlists; inspect the process tree and linked/runtime dependency manifests and assert that no Godot executable, shared library, server, command-line tool, or hidden instance is discovered, loaded, or invoked._
...
- [ ] 121. Close or verify GODOT-EXPORT-010: launch, stop, remote-deploy, and collect logs from an exported or editor-run project through existing Sim tasks
  - Apply the cataloged native Sim owner, reuse strategy, modes, failure/recovery, storage, execution, UI, persistence, lifecycle, security, limit, compatibility boundary, and platform contract. Classification remains historical; implementation may claim completion only with connected Sim behavior and hermetic no-Godot evidence.
  - _Requirements: 13.1, 13.2, 13.3, 13.4, 23.1, 23.2, 23.3, 23.4, 23.5, 23.6, 23.7, 23.8, 23.9, 23.10_
...
- [ ] 153. Close or verify GODOT-SEC-004: store export signing keys, passwords, tokens, and remote credentials through Sim secret facilities with redaction
  - Apply the cataloged native Sim owner, reuse strategy, modes, failure/recovery, storage, execution, UI, persistence, lifecycle, security, limit, compatibility boundary, and platform contract. Classification remains historical; implementation may claim completion only with connected Sim behavior and hermetic no-Godot evidence.
  - _Requirements: 17.1, 17.2, 17.3, 17.4, 23.1, 23.2, 23.3, 23.4, 23.5, 23.6, 23.7, 23.8, 23.9, 23.10_
  ...
  - _Validation: cargo test -p sandbox -p credentials_provider -p extension_host godot_security; run the SEC scenario for store export signing keys, passwords, tokens, and remote credentials through Sim secret facilities with redaction in a hermetic environment with Godot absent from PATH, loader paths, installed applications, package contents, and process allowlists; inspect the process tree and linked/runtime dependency manifests and assert that no Godot executable, shared library, server, command-line tool, or hidden instance is discovered, loaded, or invoked._
...
- [ ] 198. Close or verify GODOT-UPSTREAM-005: treat imported documentation, examples, test fixtures, and generated files as evidence until a connected Sim behavior consumes them
  - Apply the cataloged native Sim owner, reuse strategy, modes, failure/recovery, storage, execution, UI, persistence, lifecycle, security, limit, compatibility boundary, and platform contract. Classification remains historical; implementation may claim completion only with connected Sim behavior and hermetic no-Godot evidence.
  - _Requirements: 22.1, 22.2, 22.3, 22.4, 23.1, 23.2, 23.3, 23.4, 23.5, 23.6, 23.7, 23.8, 23.9, 23.10_
  ...
  - _Validation: ./script/check-licenses && cargo test -p compliance godot; run the UPSTREAM scenario for treat imported documentation, examples, test fixtures, and generated files as evidence until a connected Sim behavior consumes them in a hermetic environment with Godot absent from PATH, loader paths, installed applications, package contents, and process allowlists; inspect the process tree and linked/runtime dependency manifests and assert that no Godot executable, shared library, server, command-line tool, or hidden instance is discovered, loaded, or invoked._

- [ ] 199. Close or verify GODOT-UPSTREAM-006: reuse Sim license, dependency, compliance, CI, documentation, and release infrastructure instead of porting Godot's equivalents
  - Apply the cataloged native Sim owner, reuse strategy, modes, failure/recovery, storage, execution, UI, persistence, lifecycle, security, limit, compatibility boundary, and platform contract. Classification remains historical; implementation may claim completion only with connected Sim behavior and hermetic no-Godot evidence.
  - _Requirements: 22.1, 22.2, 22.3, 22.4, 23.1, 23.2, 23.3, 23.4, 23.5, 23.6, 23.7, 23.8, 23.9, 23.10_
  ...
  - _Validation: ./script/check-licenses && cargo test -p compliance godot; run the UPSTREAM scenario for reuse Sim license, dependency, compliance, CI, documentation, and release infrastructure instead of porting Godot's equivalents in a hermetic environment with Godot absent from PATH, loader paths, installed applications, package contents, and process allowlists; inspect the process tree and linked/runtime dependency manifests and assert that no Godot executable, shared library, server, command-line tool, or hidden instance is discovered, loaded, or invoked._
