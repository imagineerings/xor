...
Keep XR runtime support out of Zed and expose W7 native Zed spatial metadata, docs, and preview routing only when they directly support the target generative game engine.
...
- [ ] 1. Add XR boundary and spatial metadata support
  - Encode XR runtime exclusions and expose native Zed spatial asset metadata/docs hooks.
  ...
  - _Depends on: none_
  - _Reads: /Users/ahmad.vegah/repos/zed/.agents/specs/godot-migration/xr-spatial/requirements.md, /Users/ahmad.vegah/repos/zed/.agents/specs/godot-migration/xr-spatial/design.md, Cargo.toml, projects/godot_
  - _Validation: python3 .agents/skills/feature-spec/scripts/validate_spec.py /Users/ahmad.vegah/repos/zed/.agents/specs/godot-migration/xr-spatial; run supported metadata/preview and excluded-runtime scenarios without Godot and inspect processes, loaders, packages, and dependencies_
