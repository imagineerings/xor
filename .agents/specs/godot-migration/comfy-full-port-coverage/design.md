...
**Dependencies:** `.agents/specs/godot-migration/**`, the feature-spec validator, this pack's catalog validator, and Comfy compatibility fixtures.
...
**Purpose:** Validate coverage as specification governance so Comfy parity cannot regress without adding a product subsystem.
...
**Dependencies:** `.agents/specs/godot-migration/comfy-full-port-coverage/catalogs/`, the feature-spec validator, and existing task manifests.

**Rationale:** Coverage policy belongs in auditable specification tooling rather than a runtime crate or duplicate product registry.
...
| 1.4 | D-TRACE and existing design properties | Owner-spec scenario and failure-path validation |
...
| 4.6 | D-TRACE and existing design properties | Owner-spec scenario and failure-path validation |
| 4.7 | D-TRACE and existing design properties | Owner-spec scenario and failure-path validation |
| 4.8 | D-TRACE and existing design properties | Owner-spec scenario and failure-path validation |
| 4.9 | D-TRACE and existing design properties | Owner-spec scenario and failure-path validation |
| 4.10 | D-TRACE and existing design properties | Owner-spec scenario and failure-path validation |
...
| 7.4 | D-TRACE and existing design properties | Owner-spec scenario and failure-path validation |
