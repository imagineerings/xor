...
- Start gate: G0 spec consistency, G3 shared world-model foundations for artifact references, G8 Comfy harness alignment, G9 Sim coverage, and no pending contradiction with `diffusion-graph-editor/`.
...
- [ ] 1. Define Comfy control-plane protocol models
  ...
  - _Depends on: none_
  - _Reads: /Users/ahmad.vegah/repos/sim/.agents/specs/godot-migration/comfy-runtime-control-plane/requirements.md, /Users/ahmad.vegah/repos/sim/.agents/specs/godot-migration/comfy-runtime-control-plane/design.md, Cargo.toml, projects/comfy_
  - _Validation: python3 .agents/skills/feature-spec/scripts/validate_spec.py /Users/ahmad.vegah/repos/sim/.agents/specs/godot-migration/comfy-runtime-control-plane_
...
- [ ] 8. Materialize remaining runtime control-plane coverage backlog
  - Convert 47 planned coverage records in runtime-control-plane into native Sim implementation, delegation, unsupported, or divergent outcomes without ComfyUI pass-through.
  ...
  - Expected native Sim writes: crates/world_model/src/comfy_control.rs, crates/world_model/src/comfy_routes.rs, crates/world_model/src/world_model.rs, crates/world_model/src/sim_api_schema.rs, crates/world_model/src/comfy_control_tests.rs, crates/world_model/src/comfy_routes_tests.rs, crates/world_model/tests/comfy_api_compat.rs, crates/world_model/fixtures/comfy/*.json.
  - Validation: `cargo test -p world_model --test comfy_api_compat`.
  - Parity evidence: Mark records implemented only with native Sim route/job/WebSocket tests or fixtures; unsupported/divergent records need user-visible boundary reasons.
