...
- **G11 Native Godot independence**: every supported or fully specified Godot-origin capability names existing/proposed Sim owners and passes hermetic no-Godot process, package, loader, dependency, storage, execution, UI, and lifecycle validation.
...
- [ ] 1. Extend existing Sim owners for game project metadata
  ...
  - _Depends on: none_
  - _Reads: /Users/ahmad.vegah/repos/sim/.agents/specs/godot-migration/requirements.md, /Users/ahmad.vegah/repos/sim/.agents/specs/godot-migration/design.md, Cargo.toml, projects/godot_
  - _Validation: python3 .agents/skills/feature-spec/scripts/validate_spec.py /Users/ahmad.vegah/repos/sim/.agents/specs/godot-migration_
...
- [ ] 4. Add game workspace integration registration
  - Wire game project detection, Sim-owned task actions, SimScript language registration data, docs routes, and preview routing directly to existing Sim registries.
...
- [ ] 15. Enforce native Sim ownership for every Godot-origin capability
...
- Do not implement or classify as supported any task that requires Godot runtime execution; keep it unresolved, intentionally excluded, or architecture-decision blocked until Sim owns execution.
