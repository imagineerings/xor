...
- **G2 Shared Baymax game metadata**: project descriptors, diagnostics, source references, and fixture attribution exist before Godot integrations.
...
| W2 Baymax game compatibility substrate | Umbrella tasks 4 and 7 after G1/G2; grouped `engine-core-runtime`, `language-scripting`, `game-formats-assets`, and `build-test-docs` metadata/docs work |
...
- [x] 14. Extend migration inventory validation for Comfy specs
  ...
  - _writes: crates/baymax_game/src/spec_gatekeeper.rs, crates/baymax_game/src/spec_gatekeeper_tests.rs, crates/baymax_game/src/inventory_tests.rs_
