...
Wire GDScript and Godot documentation support through existing Sim language and docs infrastructure without adding a separate scripting runtime.
...
- [ ] 1. Add Godot language support
  ...
  - _writes: crates/languages/src/gdscript.rs, crates/sim_game/src/language.rs, crates/sim_game/src/docs.rs_
