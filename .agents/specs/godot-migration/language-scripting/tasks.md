...
- [ ] 1. Add SimScript language support
  ...
  - _Depends on: none_
  - _Reads: /Users/ahmad.vegah/repos/sim/.agents/specs/godot-migration/language-scripting/requirements.md, /Users/ahmad.vegah/repos/sim/.agents/specs/godot-migration/language-scripting/design.md, Cargo.toml, projects/godot_
  - _Validation: python3 .agents/skills/feature-spec/scripts/validate_spec.py /Users/ahmad.vegah/repos/sim/.agents/specs/godot-migration/language-scripting; run recognition, translation, execution, LSP, DAP, and unsupported-language scenarios without Godot and inspect all spawned servers/processes and dependencies_
