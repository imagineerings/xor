...
| G1 | Boundary policy | Godot runtime-adjacent work | Existing Sim owners, unresolved areas, and explicit exclusions are encoded and tested; no Godot delegation is permitted |
...
| G12 | Native Godot independence | Any supported or fully specified Godot-origin capability | Native Sim storage/execution/UI/lifecycle paths and compatibility boundaries are explicit; no-Godot package/process/loader/dependency validation passes |
...
| Platform and export | Godot platform/export templates | Sim platform crates, task system | Parse compatible presets into Sim-owned packaging; unsupported targets remain unresolved/excluded | `platform-export/` |
...
| `platform-export/` | Godot-compatible preset import and Sim-native packaging/deployment | Requirements + Design + Tasks | W7 |
