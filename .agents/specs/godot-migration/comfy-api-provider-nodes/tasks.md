...
- Start gate: G0 spec consistency, G4 worker safety, G6 provenance, G7 dependency review for provider SDKs, G8 Comfy harness alignment, G9 Zed coverage, and configured secret storage.
...
- [ ] 1. Implement provider node registry
  ...
  - _Writes: crates/world_model/src/zed_provider_nodes.rs, crates/world_model/src/zed_provider_nodes_tests.rs_
  - _CoverageOwner: .agents/specs/godot-migration/comfy-api-provider-nodes_
  - _Depends on: none_
  - _Reads: /Users/ahmad.vegah/repos/zed/.agents/specs/godot-migration/comfy-api-provider-nodes/requirements.md, /Users/ahmad.vegah/repos/zed/.agents/specs/godot-migration/comfy-api-provider-nodes/design.md, Cargo.toml, projects/comfy_
  - _Validation: python3 .agents/skills/feature-spec/scripts/validate_spec.py /Users/ahmad.vegah/repos/zed/.agents/specs/godot-migration/comfy-api-provider-nodes_
- [ ] 2. Implement provider policy gate
  ...
  - _Writes: crates/world_model/src/zed_provider_policy.rs, crates/world_model/src/zed_provider_policy_tests.rs_
  - _CoverageOwner: .agents/specs/godot-migration/comfy-api-provider-nodes_
  - _Depends on: 1_
  - _Reads: /Users/ahmad.vegah/repos/zed/.agents/specs/godot-migration/comfy-api-provider-nodes/requirements.md, /Users/ahmad.vegah/repos/zed/.agents/specs/godot-migration/comfy-api-provider-nodes/design.md, Cargo.toml, projects/comfy_
  - _Validation: python3 .agents/skills/feature-spec/scripts/validate_spec.py /Users/ahmad.vegah/repos/zed/.agents/specs/godot-migration/comfy-api-provider-nodes_
- [ ] 3. Implement provider secret redaction
  - Resolve credentials through Zed secrets and redact credentials, signed URLs, and sensitive payload fields.
  ...
  - _Writes: crates/world_model/src/zed_provider_secrets.rs, crates/world_model/src/zed_provider_secrets_tests.rs_
  - _CoverageOwner: .agents/specs/godot-migration/comfy-api-provider-nodes_
  - _Depends on: 2_
  - _Reads: /Users/ahmad.vegah/repos/zed/.agents/specs/godot-migration/comfy-api-provider-nodes/requirements.md, /Users/ahmad.vegah/repos/zed/.agents/specs/godot-migration/comfy-api-provider-nodes/design.md, Cargo.toml, projects/comfy_
  - _Validation: python3 .agents/skills/feature-spec/scripts/validate_spec.py /Users/ahmad.vegah/repos/zed/.agents/specs/godot-migration/comfy-api-provider-nodes_
- [ ] 4. Implement remote task lifecycle
  ...
  - _Writes: crates/world_model/src/zed_provider_connector.rs, crates/world_model/src/zed_provider_remote_tasks.rs, crates/world_model/src/zed_provider_remote_tasks_tests.rs_
  - _CoverageOwner: .agents/specs/godot-migration/comfy-api-provider-nodes_
  - _Depends on: 3_
  - _Reads: /Users/ahmad.vegah/repos/zed/.agents/specs/godot-migration/comfy-api-provider-nodes/requirements.md, /Users/ahmad.vegah/repos/zed/.agents/specs/godot-migration/comfy-api-provider-nodes/design.md, Cargo.toml, projects/comfy_
  - _Validation: python3 .agents/skills/feature-spec/scripts/validate_spec.py /Users/ahmad.vegah/repos/zed/.agents/specs/godot-migration/comfy-api-provider-nodes_
- [ ] 5. Implement provider upload/download and output import
  ...
  - _Writes: crates/world_model/src/zed_provider_io.rs, crates/world_model/src/zed_provider_io_tests.rs_
  - _CoverageOwner: .agents/specs/godot-migration/comfy-api-provider-nodes_
  - _Depends on: 4_
  - _Reads: /Users/ahmad.vegah/repos/zed/.agents/specs/godot-migration/comfy-api-provider-nodes/requirements.md, /Users/ahmad.vegah/repos/zed/.agents/specs/godot-migration/comfy-api-provider-nodes/design.md, Cargo.toml, projects/comfy_
  - _Validation: python3 .agents/skills/feature-spec/scripts/validate_spec.py /Users/ahmad.vegah/repos/zed/.agents/specs/godot-migration/comfy-api-provider-nodes_
- [ ] 6. Add provider catalog fixtures
  - Snapshot Comfy provider families and node ids from `comfy_api_nodes` into a Zed provider catalog fixture.
  - Represent fixture data as native Zed provider records with explicit `native_zed_records` and no ComfyUI pass-through.
...
- [ ] 7. Add concrete connector adapter skeletons
  ...
  - _Writes: crates/world_model/src/zed_provider_adapters.rs, crates/world_model/src/zed_provider_adapters_tests.rs_
  - _CoverageOwner: .agents/specs/godot-migration/comfy-api-provider-nodes_
  - _Depends on: 6_
  - _Reads: /Users/ahmad.vegah/repos/zed/.agents/specs/godot-migration/comfy-api-provider-nodes/requirements.md, /Users/ahmad.vegah/repos/zed/.agents/specs/godot-migration/comfy-api-provider-nodes/design.md, Cargo.toml, projects/comfy_
  - _Validation: python3 .agents/skills/feature-spec/scripts/validate_spec.py /Users/ahmad.vegah/repos/zed/.agents/specs/godot-migration/comfy-api-provider-nodes_
- [ ] 8. Materialize remaining API-provider coverage backlog
  - Convert 229 planned coverage records in api-provider-nodes into native Zed implementation, delegation, unsupported, or divergent outcomes without ComfyUI pass-through.
  ...
  - Native Zed writes: crates/world_model/src/zed_provider_nodes.rs, crates/world_model/src/world_model.rs, crates/world_model/tests/comfy_provider_catalog.rs, crates/world_model/tests/comfy_compat_suite.rs, crates/world_model/fixtures/comfy/coverage_ledger.json, crates/world_model/fixtures/comfy/provider_backlog.json.
  - Validation: `cargo test -p world_model --test comfy_provider_catalog`.
  - Parity evidence: Mark records implemented only with native Zed provider registry, policy, secret, mock connector, output import, or adapter evidence; real calls remain policy gated.
  - _CoverageTask: coverage-backlog-api-provider-nodes_
  - _CoverageOwner: .agents/specs/godot-migration/comfy-api-provider-nodes_
  - _Requirements: 9.1, 9.2, 9.3, 9.4_
  - _Writes: crates/world_model/src/zed_provider_nodes.rs, crates/world_model/src/world_model.rs, crates/world_model/tests/comfy_provider_catalog.rs, crates/world_model/tests/comfy_compat_suite.rs, crates/world_model/fixtures/comfy/coverage_ledger.json, crates/world_model/fixtures/comfy/provider_backlog.json
  - _Depends on: 7_
  - _Reads: /Users/ahmad.vegah/repos/zed/.agents/specs/godot-migration/comfy-api-provider-nodes/requirements.md, /Users/ahmad.vegah/repos/zed/.agents/specs/godot-migration/comfy-api-provider-nodes/design.md, Cargo.toml, projects/comfy_
  - _Validation: python3 .agents/skills/feature-spec/scripts/validate_spec.py /Users/ahmad.vegah/repos/zed/.agents/specs/godot-migration/comfy-api-provider-nodes_
