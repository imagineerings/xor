...
- [ ] 1. Scaffold the `mobile_tunnel` crate
...
- [ ] 2. Port SSH tunnel start logic from goose-server (reusing existing Baymax SSH infrastructure)
  - [ ] 2.1 Implement `TunnelManager::start()`
  ...
  - [ ] 2.2 Implement `TunnelManager::stop()`
...
- [ ] 4. Register the `mobile_tunnel` crate with Baymax's init
  - [ ] 4.1 Initialize `TunnelManager` during Baymax startup
...
- [ ] 5. Build the Mobile Access settings page
  - [ ] 5.1 Create the page module
  ...
  - [ ] 5.2 Register the page in settings navigation
  ...
  - [ ] 5.3 Add QR code rendering to the page
...
- [ ] 6. Add settings persistence
  - [ ] 6.1 Define `MobileAccessSettings` in the settings content types
    ...
    - _writes: crates/settings_content/src/settings_content.rs_ (or appropriate location)

  - [ ] 6.2 Wire settings to the Mobile Access page
...
- [ ] 7. Add tests
  - [ ] 7.1 Unit tests for `TunnelManager`
  ...
  - [ ] 7.2 Unit tests for QR code generation
  ...
  - [ ] 7.3 Settings page rendering tests
