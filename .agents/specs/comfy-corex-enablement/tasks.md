...
- [ ] 4. Integrate certified native device into production selection: Iluvatar CoreX/IXUCA
  ...
  - _Reads: crates/comfy_runtime/src/native_ffi_corex.rs, crates/comfy_tensor/src/backends/iluvatar_corex_ixuca_comfy_model_0020.rs, crates/comfy_worker/src/comfy_worker.rs, crates/comfy_worker/src/supervisor.rs, crates/sim/src/sim.rs, crates/comfy_ui/src/execution_surfaces.rs
  - _Writes: crates/comfy_runtime/src/native_execution_controller.rs, crates/comfy_runtime/src/runtime_supervisor.rs, crates/comfy_types/src/worker_protocol.rs, crates/comfy_worker/src/comfy_worker.rs, crates/comfy_worker/src/supervisor.rs, crates/comfy_worker/src/comfy_worker_main.rs, crates/sim/src/sim.rs, crates/sim/src/comfy_cli.rs, crates/comfy_ui/src/execution_surfaces.rs, crates/comfy_test_support/tests/native_controller_e2e.rs, crates/comfy_test_support/tests/native_release_boundary.rs
  - _Validation: cargo test --locked -p comfy_worker --features corex --all-targets; cargo test --locked -p sim --features corex --all-targets; cargo test --locked -p comfy_test_support --test native_controller_e2e; ./script/clippy -p comfy_worker -p sim -p comfy_test_support
