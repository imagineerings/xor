...
- [ ] 1. Create server crate with core infrastructure
...
- [ ] 6. Implement configuration routes
...
- [ ] 9. Implement remaining routes
  - [ ] 9.1 Dictation route — POST `/dictation`
    - _Requirements: 8_
    - _writes: crates/baymax-server/src/routes/dictation.rs_
  - [ ] 9.2 Gateway routes — gateway management
    - _Requirements: 10_
...
- [ ] 11. Implement OpenAPI documentation
