...
Migrate goose's evaluation infrastructure — Harbor eval framework, Open Model Gym, scenario tests, and benchmark scripts — into zed's existing evaluation tools (`crates/eval_cli/`, `crates/eval_utils/`).
...
- **Benchmarks in `crates/benchmarks/`**: Zed already has `crates/benchmarks/`. Extend it with agent-specific benchmarks.
...
- Zed: `crates/eval_cli/`, `crates/eval_utils/`, `crates/benchmarks/`

## Requirements traceability

| Requirement | Design element | Verification |
| --- | --- | --- |
| 1.1 | Harbor Evaluation Framework audit design | Observable scenario and failure-path test for 1.1 |
| 1.2 | Harbor Evaluation Framework audit design | Observable scenario and failure-path test for 1.2 |
| 1.3 | Harbor Evaluation Framework audit design | Observable scenario and failure-path test for 1.3 |
| 1.4 | Harbor Evaluation Framework audit design | Observable scenario and failure-path test for 1.4 |
| 2.1 | Open Model Gym audit design | Observable scenario and failure-path test for 2.1 |
| 2.2 | Open Model Gym audit design | Observable scenario and failure-path test for 2.2 |
| 2.3 | Open Model Gym audit design | Observable scenario and failure-path test for 2.3 |
| 3.1 | Scenario Tests audit design | Observable scenario and failure-path test for 3.1 |
| 3.2 | Scenario Tests audit design | Observable scenario and failure-path test for 3.2 |
| 3.3 | Scenario Tests audit design | Observable scenario and failure-path test for 3.3 |
| 3.4 | Scenario Tests audit design | Observable scenario and failure-path test for 3.4 |
| 4.1 | Benchmark Scripts audit design | Observable scenario and failure-path test for 4.1 |
| 4.2 | Benchmark Scripts audit design | Observable scenario and failure-path test for 4.2 |
| 4.3 | Benchmark Scripts audit design | Observable scenario and failure-path test for 4.3 |
| 4.4 | Benchmark Scripts audit design | Observable scenario and failure-path test for 4.4 |
