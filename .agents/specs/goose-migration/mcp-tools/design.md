...
Migrate goose's standalone MCP server tools — Computer Controller, Memory, Peekaboo, AutoVisualiser, Tutorial — into zed's MCP/extension ecosystem. Each tool becomes either a built-in MCP server (run as subprocess or in-process) or a set of native agent tools registered directly.
...
- **Document tools as native**: Computer Controller (PDF, DOCX, XLSX) maps naturally to zed's existing agent tool system (`crates/agent/src/tools/`) since these are file operations.
...
- Zed: `crates/agent/src/tools/` — existing agent tool pattern
- Zed: `crates/context_server/` — MCP client

## Requirements traceability

| Requirement | Design element | Verification |
| --- | --- | --- |
| 1.1 | Computer Controller MCP Tools audit design | Observable scenario and failure-path test for 1.1 |
| 1.2 | Computer Controller MCP Tools audit design | Observable scenario and failure-path test for 1.2 |
| 1.3 | Computer Controller MCP Tools audit design | Observable scenario and failure-path test for 1.3 |
| 1.4 | Computer Controller MCP Tools audit design | Observable scenario and failure-path test for 1.4 |
| 1.5 | Computer Controller MCP Tools audit design | Observable scenario and failure-path test for 1.5 |
| 1.6 | Computer Controller MCP Tools audit design | Observable scenario and failure-path test for 1.6 |
| 2.1 | Memory MCP Tool audit design | Observable scenario and failure-path test for 2.1 |
| 2.2 | Memory MCP Tool audit design | Observable scenario and failure-path test for 2.2 |
| 2.3 | Memory MCP Tool audit design | Observable scenario and failure-path test for 2.3 |
| 2.4 | Memory MCP Tool audit design | Observable scenario and failure-path test for 2.4 |
| 2.5 | Memory MCP Tool audit design | Observable scenario and failure-path test for 2.5 |
| 3.1 | Peekaboo Screen Monitoring audit design | Observable scenario and failure-path test for 3.1 |
| 3.2 | Peekaboo Screen Monitoring audit design | Observable scenario and failure-path test for 3.2 |
| 3.3 | Peekaboo Screen Monitoring audit design | Observable scenario and failure-path test for 3.3 |
| 4.1 | AutoVisualiser audit design | Observable scenario and failure-path test for 4.1 |
| 4.2 | AutoVisualiser audit design | Observable scenario and failure-path test for 4.2 |
| 4.3 | AutoVisualiser audit design | Observable scenario and failure-path test for 4.3 |
| 4.4 | AutoVisualiser audit design | Observable scenario and failure-path test for 4.4 |
| 5.1 | Tutorial MCP Tool audit design | Observable scenario and failure-path test for 5.1 |
| 5.2 | Tutorial MCP Tool audit design | Observable scenario and failure-path test for 5.2 |
| 5.3 | Tutorial MCP Tool audit design | Observable scenario and failure-path test for 5.3 |
| 5.4 | Tutorial MCP Tool audit design | Observable scenario and failure-path test for 5.4 |
| 6.1 | MCP Server Runner audit design | Observable scenario and failure-path test for 6.1 |
| 6.2 | MCP Server Runner audit design | Observable scenario and failure-path test for 6.2 |
| 6.3 | MCP Server Runner audit design | Observable scenario and failure-path test for 6.3 |
