...
graph TD
    ...
    subgraph "Analytics"
        PostHog[Conditional telemetry exporter]
...
| --- | --- | --- |
| 1.1 | Langfuse Tracing audit design | Observable scenario and failure-path test for 1.1 |
| 1.2 | Langfuse Tracing audit design | Observable scenario and failure-path test for 1.2 |
| 1.3 | Langfuse Tracing audit design | Observable scenario and failure-path test for 1.3 |
| 1.4 | Langfuse Tracing audit design | Observable scenario and failure-path test for 1.4 |
| 2.1 | OpenTelemetry OTLP Export audit design | Observable scenario and failure-path test for 2.1 |
| 2.2 | OpenTelemetry OTLP Export audit design | Observable scenario and failure-path test for 2.2 |
| 2.3 | OpenTelemetry OTLP Export audit design | Observable scenario and failure-path test for 2.3 |
| 3.1 | Observation Layer audit design | Observable scenario and failure-path test for 3.1 |
| 3.2 | Observation Layer audit design | Observable scenario and failure-path test for 3.2 |
| 3.3 | Observation Layer audit design | Observable scenario and failure-path test for 3.3 |
| 3.4 | Observation Layer audit design | Observable scenario and failure-path test for 3.4 |
| 4.1 | Rate Limiter audit design | Observable scenario and failure-path test for 4.1 |
| 4.2 | Rate Limiter audit design | Observable scenario and failure-path test for 4.2 |
| 4.3 | Rate Limiter audit design | Observable scenario and failure-path test for 4.3 |
| 4.4 | Rate Limiter audit design | Observable scenario and failure-path test for 4.4 |
| 5.1 | PostHog Analytics audit design | Observable scenario and failure-path test for 5.1 |
| 5.2 | PostHog Analytics audit design | Observable scenario and failure-path test for 5.2 |
| 5.3 | PostHog Analytics audit design | Observable scenario and failure-path test for 5.3 |
| 5.4 | PostHog Analytics audit design | Observable scenario and failure-path test for 5.4 |
| 6.1 | Token Counter audit design | Observable scenario and failure-path test for 6.1 |
| 6.2 | Token Counter audit design | Observable scenario and failure-path test for 6.2 |
| 6.3 | Token Counter audit design | Observable scenario and failure-path test for 6.3 |
| 6.4 | Token Counter audit design | Observable scenario and failure-path test for 6.4 |
| 7.1 | Tool Monitoring audit design | Observable scenario and failure-path test for 7.1 |
| 7.2 | Tool Monitoring audit design | Observable scenario and failure-path test for 7.2 |
| 7.3 | Tool Monitoring audit design | Observable scenario and failure-path test for 7.3 |
| 8.1 | Tool Inspection audit design | Observable scenario and failure-path test for 8.1 |
| 8.2 | Tool Inspection audit design | Observable scenario and failure-path test for 8.2 |
| 8.3 | Tool Inspection audit design | Observable scenario and failure-path test for 8.3 |
