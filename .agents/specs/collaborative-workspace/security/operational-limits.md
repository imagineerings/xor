...
| OL-PUS-04 | Public gateway JSON is ≤8,192 bytes with concurrency ≤256 and request timeout 20s. Overload/timeout uses the closed temporary-unavailable response. | Sim push gateway HTTP admission | `push_gateway_inflight`, `push_gateway_request_seconds`; warn inflight ≥205 or p95 >10s for 5m, page ≥243 or p99 >20s | Tasks 22.9, 22.10, 22.12 |
