---
name: land
description: Monitor Zed PR checks, address CI failures with up to 3 fix-and-push cycles, and squash-merge the PR once checks pass.
---
...
Zed uses root GitHub workflows such as `run_tests.yml`, `release.yml`, and
