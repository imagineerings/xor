---
name: commit
description: Stage and commit changes in Zed with repo-appropriate validation, a conventional multi-line message, and Co-authored-by attribution.
---

# commit skill

Use this skill whenever you need to create a git commit in the Zed workspace.
