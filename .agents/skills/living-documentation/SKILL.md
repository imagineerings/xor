...
description: Sync spec files with code changes. Triggers when modifying code that affects .agents/specs/*/requirements.md or .agents/specs/*/design.md. Use after implementing features, fixing bugs, or refactoring that changes behavior documented in specs.
---
