...
name: gpui-test
description: >-
  Use when writing, debugging, or reproducing GPUI tests in Baymax, including
...
- `BAYMAX_HEADLESS=1` — forces GPUI platform guessing toward headless mode; useful for tests that otherwise interact with platform/window setup.
