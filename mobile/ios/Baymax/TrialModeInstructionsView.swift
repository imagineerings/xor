...
struct TrialModeInstructionsView: View {
    ...
    // Download URL for Baymax Desktop - always redirects to latest version
    private let baymaxDesktopDownloadURL =
    ...
    var body: some View {
        NavigationView {
            ScrollView {
                VStack(alignment: .leading, spacing: 24) {
                    ...
                    VStack(alignment: .leading, spacing: 8) {
                        ...
                        Text(
                            "Follow these simple steps to link your iPhone to your desktop Baymax agent"
                        )
                        .font(.system(size: 16))
                    ...
                    VStack(alignment: .leading, spacing: 20) {
                        VStack(alignment: .leading, spacing: 12) {
                            InstructionStep(
                                ...
                                description:
                                    "Download and install the Baymax desktop application on your computer if you haven't already.",
                        ...
                        InstructionStep(
                            ...
                            description:
                                "Open Baymax desktop, go to Settings → App, and turn on the Tunneling option.",
                            icon: "network"
                        )
                    ...
                    VStack(alignment: .leading, spacing: 12) {
                        ...
                        Text(
                            "Make sure both devices are connected to the internet. The tunneling feature creates a secure connection between your iPhone and desktop, allowing you to access your personal Baymax agent from anywhere."
                        )
                        .font(.system(size: 14))
                        .foregroundColor(.secondary)
                        .fixedSize(horizontal: false, vertical: true)
            ...
            .sheet(isPresented: $showingDownloadSheet) {
                DownloadLinkSheet(downloadURL: baymaxDesktopDownloadURL)
            }
        }
    }
}
...
class DownloadActivityItemSource: NSObject, UIActivityItemSource {
    ...
    func activityViewController(
        ...
        return "Download Baymax Desktop"
    }
