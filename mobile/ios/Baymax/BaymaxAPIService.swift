...
class BaymaxAPIService: ObservableObject {
    static let shared = BaymaxAPIService()
    ...
    private var baseURL: String {
        UserDefaults.standard.string(forKey: "baymax_base_url") ?? "http://127.0.0.1:62996"
    }

    private var secretKey: String {
        UserDefaults.standard.string(forKey: "baymax_secret_key") ?? "test"
    }
