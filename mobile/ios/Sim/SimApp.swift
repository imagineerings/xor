...
struct SimApp: App {
    ...
    private func initializeDefaultsIfNeeded() {
        let hasConfiguredURL = UserDefaults.standard.object(forKey: "sim_base_url") != nil
        let hasConfiguredSecret = UserDefaults.standard.object(forKey: "sim_secret_key") != nil
        ...
        if !hasConfiguredURL && !hasConfiguredSecret {
            ...
            UserDefaults.standard.set("https://demo-simed.fly.dev", forKey: "sim_base_url")
            UserDefaults.standard.set("test", forKey: "sim_secret_key")
