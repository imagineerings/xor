...
struct SettingsView: View {
    ...
    @StateObject private var apiService = SimAPIService.shared
    ...
    private func loadSettings() {
        baseURL = UserDefaults.standard.string(forKey: "sim_base_url") ?? "http://127.0.0.1:62996"
        secretKey = UserDefaults.standard.string(forKey: "sim_secret_key") ?? "test"
    }

    private func saveSettings() {
        UserDefaults.standard.set(baseURL, forKey: "sim_base_url")
        UserDefaults.standard.set(secretKey, forKey: "sim_secret_key")
    ...
    private func testConnection() {
        ...
        let originalBaseURL = UserDefaults.standard.string(forKey: "sim_base_url")
        let originalSecretKey = UserDefaults.standard.string(forKey: "sim_secret_key")
            ...
            await MainActor.run {
                ...
                if !apiService.isConnected {
                    ...
                    if let originalURL = originalBaseURL {
                        UserDefaults.standard.set(originalURL, forKey: "sim_base_url")
                    }
                    if let originalKey = originalSecretKey {
                        UserDefaults.standard.set(originalKey, forKey: "sim_secret_key")
                    }
                }
