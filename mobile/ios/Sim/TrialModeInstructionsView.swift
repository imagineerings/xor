...
struct TrialModeInstructionsView: View {
    ...
    // Download URL for Sim Desktop - always redirects to latest version
    private let simDesktopDownloadURL =
        "https://github.com/block/sim/releases/latest/download/Sim.zip"
    ...
    var body: some View {
        NavigationView {
            ScrollView {
                VStack(alignment: .leading, spacing: 24) {
                    ...
                    VStack(alignment: .leading, spacing: 8) {
                        Text("Connect to Your Sim Desktop")
                            .font(.system(size: 28, weight: .bold))
                            .foregroundColor(.primary)

                        Text(
                            "Follow these simple steps to link your iPhone to your desktop Sim agent"
                        )
                        .font(.system(size: 16))
                    ...
                    VStack(alignment: .leading, spacing: 20) {
                        VStack(alignment: .leading, spacing: 12) {
                            InstructionStep(
                                number: 1,
                                title: "Install Sim Desktop",
                                description:
                                    "Download and install the Sim desktop application on your computer if you haven't already.",
                        ...
                        InstructionStep(
                            ...
                            description:
                                "Open Sim desktop, go to Settings → App, and turn on the Tunneling option.",
                            icon: "network"
                        )
                    ...
                    VStack(alignment: .leading, spacing: 12) {
                        ...
                        Text(
                            "Make sure both devices are connected to the internet. The tunneling feature creates a secure connection between your iPhone and desktop, allowing you to access your personal Sim agent from anywhere."
                        )
                        .font(.system(size: 14))
                        .foregroundColor(.secondary)
                        .fixedSize(horizontal: false, vertical: true)
            ...
            .sheet(isPresented: $showingDownloadSheet) {
                DownloadLinkSheet(downloadURL: simDesktopDownloadURL)
            }
        }
    }
}
