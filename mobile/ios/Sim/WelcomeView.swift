...
struct WelcomeView: View {
    ...
    @State private var maxDaysToLoad: Int = 90  // Only load sessions from last 10 days - next step being a chatmeta query but i dont think we get that data from simed
    ...
    private func loadRecentSessions() async {
        ...
        if !cachedSessions.isEmpty {
            ...
            Task.detached(priority: .background) {
                _ = await SimAPIService.shared.fetchInsights()
