# BaymaxChat iOS - TestFlight Deployment Guide

## Current Project Status
- **Bundle ID**: `com.baymax.chat` (needs to be changed to your unique identifier)
- **Version**: 1.0
- **Build**: 1
...
1. Open the project in Xcode: `open BaymaxChat.xcodeproj`
2. Select the **BaymaxChat** project in the navigator
3. Select the **BaymaxChat** target
4. Go to **Signing & Capabilities** tab
5. Change Bundle Identifier to something unique:
   - Format: `com.yourcompany.baymaxchat`
...
3. In Xcode, navigate to `BaymaxChat/Assets.xcassets/AppIcon`
...
3. Fill in the required information:
   - **Platform**: iOS
   - **App Name**: BaymaxChat (or your chosen name)
   - **Primary Language**: English (or your preference)
   - **Bundle ID**: Select the one you configured
   - **SKU**: A unique identifier (e.g., "BAYMAXCHAT001")
4. Click **Create**

### 6. Build and Archive
In Xcode:
1. Select **Any iOS Device (arm64)** as the build destination (top toolbar)
2. Ensure scheme is set to **BaymaxChat**
...
xcodebuild -showBuildSettings -project BaymaxChat.xcodeproj | grep -E "PRODUCT_BUNDLE_IDENTIFIER|MARKETING_VERSION|CURRENT_PROJECT_VERSION"

# Build archive
xcodebuild -project BaymaxChat.xcodeproj \
  -scheme BaymaxChat \
  -configuration Release \
  -archivePath ./build/BaymaxChat.xcarchive \
  archive
