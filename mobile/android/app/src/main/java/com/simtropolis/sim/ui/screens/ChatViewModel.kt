...
import com.simtropolis.sim.data.repository.ContinuousVoiceManager
import com.simtropolis.sim.data.repository.SessionPoller
import com.simtropolis.sim.data.repository.VoiceManager
import com.simtropolis.sim.data.repository.VoiceManagerCallback
import com.simtropolis.sim.ui.components.CompletedToolCallData
import com.simtropolis.sim.ui.components.ToolCallWithTiming
...
class ChatViewModel : ViewModel() {
    ...
    val voiceManager: VoiceManager by lazy {
        VoiceManager(SimApplication.instance).apply {
            callback = voiceCallback
        }
    }
    val continuousVoiceManager: ContinuousVoiceManager by lazy {
        ContinuousVoiceManager(SimApplication.instance).apply {
