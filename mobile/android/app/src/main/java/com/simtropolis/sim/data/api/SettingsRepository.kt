...
private val Context.dataStore: DataStore<Preferences> by preferencesDataStore(name = "sim_settings")

class SettingsRepository(private val context: Context) {
    
    companion object {
        private val BASE_URL_KEY = stringPreferencesKey("sim_base_url")
        private val SECRET_KEY_KEY = stringPreferencesKey("sim_secret_key")
        
        const val DEFAULT_BASE_URL = "https://demo-simed.fly.dev"
    ...
    val isTrialModeFlow: Flow<Boolean> = baseUrlFlow.map { url ->
        url.contains("demo-simed.fly.dev")
    }
