...
import com.simtropolis.sim.ui.components.CompletedToolCallData
import com.simtropolis.sim.ui.components.FullTextOverlay
import com.simtropolis.sim.ui.components.MessageBubble
import com.simtropolis.sim.ui.components.StackedToolCallsView
import com.simtropolis.sim.ui.components.ToolCallCard
import com.simtropolis.sim.ui.components.ToolCallState
...
private fun buildMessageDisplayItems(
    ...
    activeToolCalls: Map<String, com.simtropolis.sim.ui.components.ToolCallWithTiming>,
    completedToolCalls: Map<String, com.simtropolis.sim.ui.components.CompletedToolCallData>
): List<DisplayItem> {
        ...
        for (message in messages) {
            if (message.hasNonEmptyTextContent) {
                ...
                for (content in message.content) {
                    when (content) {
                        is com.simtropolis.sim.data.model.MessageContent.ToolRequest -> {
